...
public class DecoClientUtilsRender {
    ...
    public static boolean renderPane(RenderBlocks render, int x, int y, int z, BlockPane pane)
    {
        ...
        else
        {
            ...
            var64 = render.blockAccess == null ? render.getBlockIconFromSideAndMetadata(pane, 0, var66) : render.getBlockIcon(pane, render.blockAccess, x, y, z, 0);
            var65 = pane.getSideTextureIndex();
        }
        ...
        GlassPaneRenderer.renderThin(render, pane, var64, x, y, z, north, south, east, west);
