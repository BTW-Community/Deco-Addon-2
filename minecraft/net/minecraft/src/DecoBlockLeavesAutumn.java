...
public class DecoBlockLeavesAutumn extends Block
{
    ...
    protected DecoBlockLeavesAutumn(int par1)
    {
        ...
        this.setUnlocalizedName("decoBlockLeavesAutumn");
    }
    ...
    {
        return DecoDefs.autumnSapling.blockID;
    }
	...
	{
		icons[0] = Register.registerIcon("decoBlockLeavesAutumnRed");
		icons[1] = Register.registerIcon("decoBlockLeavesAutumnOrange");
		icons[2] = Register.registerIcon("decoBlockLeavesAutumnYellow");
	}
