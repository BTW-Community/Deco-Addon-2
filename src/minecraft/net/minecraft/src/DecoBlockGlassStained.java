...
public class DecoBlockGlassStained extends FCBlockGlass
{
	public DecoBlockGlassStained(int ID)
	{
    ...
    public ItemStack GetStackRetrievedByBlockDispenser(World var1, int var2, int var3, int var4)
    {
        ...
        return new ItemStack(DecoDefs.stainedGlassItem, 1, var5);
    }
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        ...
        if (this.canSilkHarvest(par6) && EnchantmentHelper.getSilkTouchModifier(par2EntityPlayer))
        {
            ...
            ItemStack var8 = new ItemStack(DecoDefs.stainedGlassItem, 1, var5);
