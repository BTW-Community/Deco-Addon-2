...
public class AddonItemBlockWoodSlab extends FCItemBlockSlab {
	public AddonItemBlockWoodSlab(int var1) {
		super(var1);
	}
	
	public void getSubItems(int var1, CreativeTabs var2, List var3)
	{
		for (int i = 0; i < ((AddonBlockWoodSlab) Block.blocksList[var1]).blockTypes.length; ++i)
    ...
    public boolean attemptToCombineWithBlock(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, boolean var8)
    {
        if (this.canCombineWithBlock(var3, var4, var5, var6, var1.getItemDamage()))
        {
            ...
            if (var10 != null && var10 instanceof AddonBlockWoodSlab)
            {
            	AddonBlockWoodSlab var11 = (AddonBlockWoodSlab)var10;
    ...
    public boolean canCombineWithBlock(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (var6 == this.getBlockID())
        {
            ...
            {
                int var8 = ((AddonBlockWoodSlab)var7).SetIsUpsideDown(var1.getBlockMetadata(var2, var3, var4), false);
