...
public class AddonItemBloodMossSpores extends FCItemBloodMossSpores {
	public AddonItemBloodMossSpores(int var1) {
		super(var1);
	}
                    ...
                    if (var3.canPlaceEntityOnSide(var14, var11.i, var11.j, var11.k, false, var7, var2, var1))
                    {
                        if (!var3.isRemote)
                        {
                            ...
                            if (var3.setBlockAndMetadataWithNotify(var11.i, var11.j, var11.k, var14, var17))
                            {
                                ...
                                var3.playAuxSFX(AddonManager.addonCustomBlockPlaceAuxFXID, var11.i, var11.j, var11.k, var14 + (var17 << 12));
