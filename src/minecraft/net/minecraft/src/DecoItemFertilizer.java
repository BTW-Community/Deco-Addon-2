				...
				while (true)
				{
					...
					if (Test && world.getBlockId(NewX, NewY, NewZ) == 0)
					{
						...
						else if (itemRand.nextInt(3) == 0 && Block.plantYellow.canBlockStay(world, NewX, NewY, NewZ))
						{
							...
							case 14:
							case 15:
								world.setBlockAndMetadataWithNotify(NewX, NewY, NewZ, DecoDefs.flower.blockID, R);
								break;
							case 16:
							...
							case 20:
							case 21:
								world.setBlockAndMetadataWithNotify(NewX, NewY, NewZ, DecoDefs.tulip.blockID, R-18);
								break;
							case 22:
								world.setBlockAndMetadataWithNotify(NewX, NewY, NewZ, DecoDefs.flower2.blockID, R-22);
								break;
