...
public class DecoBlockRedSandSlab extends FCBlockSlabFalling
{
    public DecoBlockRedSandSlab(int var1)
    {
    ...
    {
        this.DropItemsIndividualy(var1, var2, var3, var4, DecoDefs.pileRedSand.itemID, 3, 0, var6);
        return true;
    }
	...
	{
		return DecoDefs.redSand.getIcon(Side, Meta);
	}
