...
public class DecoBlockCobbleLooseAndesite extends FCBlockLavaReceiver
{
    public DecoBlockCobbleLooseAndesite(int var1)
    {
    ...
    {
        world.setBlockAndMetadataWithNotify(x, y, z, DecoDefs.stoneTypesCobble.blockID, 1);
        return true;
    }
    ...
    public void registerIcons(IconRegister Register)
    {
    	...
    	lavaCrackOverlay = Register.registerIcon("decoOverlayAndesiteCobbleLava");
    }
