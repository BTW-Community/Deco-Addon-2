...
public class DecoBlockLogDamaged extends FCBlockLogDamaged {
	...
	public DecoBlockLogDamaged(int id, String side, String top, String stump) {
		super(id);
		topTexture = top;
		sideTexture = side;
		stumpTexture = stump;
    ...
    {
    	if (this.blockID == DecoDefs.logDamagedBlood.blockID)
    ...
    public boolean ConvertBlock(ItemStack var1, World var2, int var3, int var4, int var5, int var6)
    {
        ...
        else
        {
            ...
            if (!var2.isRemote)
            {
                ...
                {
                    var2.playAuxSFX(DecoManager.decoShaftRippedOffLogAuxFXID, var3, var4, var5, 0);
	...
	public static int getLogSpikeFromBlockID(int id) {
		...
		else if (id == DecoDefs.logDamagedSpruce.blockID)
			return DecoDefs.logSpikeSpruce.blockID;
		else if (id == DecoDefs.logDamagedBirch.blockID)
			return DecoDefs.logSpikeBirch.blockID;
		else if (id == DecoDefs.logDamagedJungle.blockID)
			return DecoDefs.logSpikeJungle.blockID;
		else if (id == DecoDefs.logDamagedBlood.blockID)
