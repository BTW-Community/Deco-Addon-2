...
public class DecoEntityCreeper extends FCEntityCreeper {
	public DecoEntityCreeper(World var1) {
		super(var1);
	}
    ...
    public boolean interact(EntityPlayer var1)
    {
        ...
        if (var2 != null && (var2.itemID == Item.shears.itemID || var2.itemID == DecoDefs.shearsDiamond.itemID) && this.GetNeuteredState() == 0)
        {
