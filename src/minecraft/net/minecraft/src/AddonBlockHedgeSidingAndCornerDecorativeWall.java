...
public class AddonBlockHedgeSidingAndCornerDecorativeWall extends AddonBlockSidingAndCornerDecorativeWall {
	...
	public AddonBlockHedgeSidingAndCornerDecorativeWall(int var1, Material var2, String var3, float var4, float var5, StepSound var6, String var7, String originalName, boolean shouldColor, Block owner, int ownerMeta) {
