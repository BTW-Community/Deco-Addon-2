...
public class DecoBlockLogAcaciaStump extends Block {
	public DecoBlockLogAcaciaStump(int id) {
        ...
        this.setUnlocalizedName("acaciaLogStump");
	}
	...
	public void registerIcons(IconRegister register) {
		sideIcon = register.registerIcon("decoBlockTrunkAcacia_side");
		topIcon = register.registerIcon("decoBlockTrunkAcacia_top");
	}
}