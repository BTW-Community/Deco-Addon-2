...
public class AddonBlockNetherBrickSuperheated extends Block {
	public AddonBlockNetherBrickSuperheated(int id) {
    ...
    {
        return var3 == 0 ? FCBetterThanWolves.fcBlockNetherBrickLoose.blockID : AddonDefs.netherBrickLoose.blockID;
    }
	...
	public void updateTick(World world, int x, int y, int z, Random rand)
	{
		...
		int idCooled = meta == 0 ? Block.netherBrick.blockID : AddonDefs.netherBrick.blockID;
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        ...
        if (this.canSilkHarvest(par6) && EnchantmentHelper.getSilkTouchModifier(par2EntityPlayer))
        {
            ...
            ItemStack var9 = new ItemStack(AddonDefs.netherBrick);
