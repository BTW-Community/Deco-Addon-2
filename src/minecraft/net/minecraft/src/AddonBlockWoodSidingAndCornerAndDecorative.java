...
public class AddonBlockWoodSidingAndCornerAndDecorative extends AddonBlockSidingAndCornerAndDecorative
{
    protected AddonBlockWoodSidingAndCornerAndDecorative(int var1, String var2, String var3)
    {
