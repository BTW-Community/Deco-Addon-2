...
public class AddonBlockStone extends Block {
	...
	{
		if (var5 == 0) {
			this.DropItemsIndividualy(var1, var2, var3, var4, AddonDefs.graniteCobbleLoose.blockID, 1, 0, var6);
		}
		else if (var5 == 1) {
			this.DropItemsIndividualy(var1, var2, var3, var4, AddonDefs.andesiteCobbleLoose.blockID, 1, 0, var6);
		}
		else if (var5 == 2) {
			this.DropItemsIndividualy(var1, var2, var3, var4, AddonDefs.dioriteCobbleLoose.blockID, 1, 0, var6);
		}
		return true;
	}
