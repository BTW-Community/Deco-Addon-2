...
public class DecoBlockFireStoked extends FCBlockFireStoked {
    protected DecoBlockFireStoked(int id) {
		super(id);
	}
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5)
    {
        if (this.ValidateState(var1, var2, var3, var4))
        {
            ...
            {
                var1.setBlockWithNotify(var2, var3 + 1, var4, DecoDefs.netherrackSuperheated.blockID);
            }
            else if (var1.getBlockId(var2, var3 + 1, var4) == Block.netherBrick.blockID) 
            {
                var1.setBlockWithNotify(var2, var3 + 1, var4, DecoDefs.netherBrickSuperheated.blockID);
                var1.setBlockMetadata(var2, var3 + 1, var4, 0);
            }
            else if (var1.getBlockId(var2, var3 + 1, var4) == DecoDefs.netherBrick.blockID) 
            {
