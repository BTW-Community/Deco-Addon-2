...
public class RenderGlobal implements IWorldAccess
{
        ...
        if (!this.damagedBlocks.isEmpty())
        {
            ...
            while (var10.hasNext())
            {
                ...
                else
                {
                    ...
                    var19.RenderBlockWithTexture(this.globalRenderBlocks, var11.getPartialBlockX(), var11.getPartialBlockY(), var11.getPartialBlockZ(), this.destroyBlockIcons[var11.getPartialBlockDamage()]);
                }
            }
    ...
    public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3, ItemStack par4ItemStack, float par5)
    {
        if (par3 == 0 && par2MovingObjectPosition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (var7 > 0)
            {
                ...
                this.drawOutlinedBoundingBox(Block.blocksList[var7].getSelectedBoundingBoxFromPool(this.theWorld, par2MovingObjectPosition).expand((double)var6, (double)var6, (double)var6).getOffsetBoundingBox(-var8, -var10, -var12));
            }
        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var21 = new FCClientEntityWhiteSmokeFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                    }
                    else if (par1Str.equals("fcwhitecloud"))
                    {
                        var21 = new FCClientEntityWhiteCloudFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                    }
    ...
    public void broadcastSound(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        switch (par1)
        {
            ...
            default:
                FCAddOnHandler.ClientPlayCustomAuxFX(this.mc, this.theWorld, (EntityPlayer)null, par1, par2, par3, par4, par5);
        }
    }
    ...
    public void playAuxSFX(EntityPlayer par1EntityPlayer, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        switch (par2)
        {
            ...
            case 1016:
                ...
                this.theWorld.playSound((double)par3 + 0.5D, (double)par4 + 0.5D, (double)par5 + 0.5D, "mob.zombie.say", 1.0F + var7.nextFloat(), var7.nextFloat() * 0.2F + 0.5F, false);
                break;
            ...
            default:
                FCAddOnHandler.ClientPlayCustomAuxFX(this.mc, this.theWorld, par1EntityPlayer, par2, par3, par4, par5, par6);
        }
    }
    ...
    public Icon GetDestroyedBlockIcon(int var1)
    {
        if (var1 >= 10 || var1 < 0)
        {
            var1 = 0;
        ...
        return this.destroyBlockIcons[var1];
    }
}
