...
public class DecoBlockLogAcacia extends Block {
	public DecoBlockLogAcacia(int id) {
		...
		this.setUnlocalizedName("decoBlockAcaciaLog");
		this.setCreativeTab(CreativeTabs.tabBlock);
	}

    public int GetFurnaceBurnTime(int var1)
    {
        return FCBlockPlanks.GetFurnaceBurnTimeByWoodType(0) * 4;
    }
	...
	public boolean ConvertBlock(ItemStack var1, World var2, int var3, int var4, int var5, int var6)
	{
		...
		var2.setBlockAndMetadataWithNotify(var3, var4, var5, DecoDefs.logDamagedAcacia.blockID, var10);

		if (!var2.isRemote && ((var7 & 3) == 0 || (var7 & 3) == 2))
		{
			FCUtilsItem.EjectStackFromBlockTowardsFacing(var2, var3, var4, var5, new ItemStack(FCBetterThanWolves.fcItemBark, 1, 6), var6);
		}
	...
	public boolean OnBlockSawed(World var1, int var2, int var3, int var4)
	{
		...
		if ((meta & 3) == 0 || (meta & 3) == 2)
			FCUtilsItem.EjectSingleItemWithRandomOffset(var1, var2, var3, var4, FCBetterThanWolves.fcItemBark.itemID, 6);
	...
	public boolean DropComponentItemsOnBadBreak(World var1, int var2, int var3, int var4, int var5, float var6)
	{
		...
		this.DropItemsIndividualy(var1, var2, var3, var4, FCBetterThanWolves.fcItemBark.itemID, 1, 6, var6);
		return true;
	}
	...
	//CLIENT ONLY
	public static String[] topTextures = {"decoBlockLogAcacia_top", "decoBlockStrippedAcacia_top", "decoBlockLogAcacia_side", "decoBlockStrippedAcacia_side"};
	public static String[] sideTextures = {"decoBlockLogAcacia_side", "decoBlockStrippedAcacia_side", "decoBlockLogAcacia_side", "decoBlockStrippedAcacia_side"};
