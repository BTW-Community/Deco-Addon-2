...
public class AddonBlockSlabStone extends AddonBlockSlabBase
{
	...
	public AddonBlockSlabStone(int par1, Block[] blocks, int[] metas, boolean[] mortared, Block[] looseDrop, int[] looseDropMeta)
	{
	...
	public AddonBlockSlabStone(int par1, Block[] blocks, int[] metas)
	{
		super(par1, Material.rock, blocks, metas);
		this.setHardness(2.0F);
		this.setResistance(10.0F);
