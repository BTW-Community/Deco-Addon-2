...
public class DecoBlockWaterStationary extends FCBlockWaterStationary {
	public DecoBlockWaterStationary(int id, Material material) {
		super(id, material);
	}
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand)
    {
        ...
        {
            var21 = (double)((float)x + rand.nextFloat());
            var11 = (double)y - DecoUtilsBlock.getFluidDripOffsetForBlockType(world.getBlockId(x, y - 1, z), world.getBlockMetadata(x, y - 1, z));
            var22 = (double)((float)z + rand.nextFloat());
