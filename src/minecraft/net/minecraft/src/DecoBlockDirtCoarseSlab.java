...
public class DecoBlockDirtCoarseSlab extends FCBlockSlabAttached {

	protected DecoBlockDirtCoarseSlab(int ID) {
	...
	public int GetCombinedBlockID(int var1) {
		return DecoDefs.coarseDirt.blockID;
	}
	
	//CLIENT ONLY
	public Icon getIcon(int Side, int Meta)
	{
		return DecoDefs.coarseDirt.getIcon(Side, Meta);
	}
