...
public class AddonBlockWorkStump extends FCBlockWorkStump {
	protected AddonBlockWorkStump(int id) {
		super(id);
	}
    ...
    public ItemStack GetStackRetrievedByBlockDispenser(World var1, int var2, int var3, int var4)
    {
    	...
    	if (meta == 4)
    		return AddonDefs.cherryLog.GetStackRetrievedByBlockDispenser(var1, var2, var3, var4);
    	else
    ...
    public boolean ConvertBlock(ItemStack var1, World var2, int var3, int var4, int var5, int var6)
    {
        ...
        var2.setBlockAndMetadataWithNotify(var3, var4, var5, AddonUtilsBlock.getDamagedLogFromMetadata(meta & 3), var8);
