...
class ThreadOnlineConnect extends Thread
{
    ...
    public void run()
    {
        try
        {
            TaskOnlineConnect.func_96583_a(this.field_96594_c, new DawnNetClientHandler(this.field_96594_c.func_96578_b(), this.field_96595_a, this.field_96593_b, TaskOnlineConnect.func_98172_a(this.field_96594_c)));
