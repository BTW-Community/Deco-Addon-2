...
public class AddonBlockHempCrop extends FCBlockHempCrop {

	public AddonBlockHempCrop(int var1) {
		super(var1);
	}
    ...
    public void harvestBlock(World var1, EntityPlayer var2, int var3, int var4, int var5, int var6)
    {
        ...
        if (!var1.isRemote && !(var2.getCurrentEquippedItem() != null && (var2.getCurrentEquippedItem().itemID == Item.shears.itemID || var2.getCurrentEquippedItem().itemID == AddonDefs.shearsDiamond.itemID)) && var1.getBlockId(var3, var4 - 1, var5) == this.blockID)
        {
