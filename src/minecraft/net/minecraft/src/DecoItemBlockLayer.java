...
public class DecoItemBlockLayer extends ItemBlock {
	public DecoItemBlockLayer(int par1) {
		super(par1);
	}
	...
	public boolean attemptToCombineWithBlock(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, boolean var8)
	{
		...
		if (this.canCombineWithBlock(var3, var4, var5, var6, var1.getItemDamage()))
		{
			...
			if (var10 != null && var10 instanceof DecoBlockLayer)
			{
				DecoBlockLayer var11 = (DecoBlockLayer)var10;
    ...
    public boolean addLayer(World var1, int var2, int var3, int var4)
    {
        ...
        return var6 instanceof DecoBlockLayer ? ((DecoBlockLayer)var6).addLayer(var1, var2, var3, var4) : false;
    }
