...
public class HugeTreeGrower extends AbstractTreeGrower {
	...
	void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, int par6, boolean isWorldGen)
	{
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					{
						this.setBlockAndMetadata(worldObj, var11[0], var11[1], var11[2], par6, 0, isWorldGen);
						++var13;
					}
				}
			}
	...
	void generateLeafNode(int par1, int par2, int par3, boolean isWorldGen)
	{
		...
		for (int var5 = par2 + leafDistanceLimit; var4 < var5; ++var4)
		{
			...
			this.genTreeLayer(par1, var4, par3, var6, (byte)1, Block.leaves.blockID, isWorldGen);
		}
	}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int blockID, int metadata, boolean isWorldGen)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				this.setBlockAndMetadata(worldObj, var14[0], var14[1], var14[2], blockID, var17, isWorldGen);
			}
		}
	}
	...
	void generateTrunk(boolean isWorldGen)
	{
		...
		this.placeBlockLine(var5, var6, Block.wood.blockID, 0, isWorldGen);
	...
	void generateLeafNodeBases(boolean isWorldGen)
	{
		...
		for (int[] var3 = new int[] {basePos[0], basePos[1], basePos[2]}; var1 < var2; ++var1)
		{
			...
			{
				this.placeBlockLine(var3, var5, Block.wood.blockID, 0, isWorldGen);
			}
		}
	}
