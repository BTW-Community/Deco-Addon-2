...
public class HugeTreeGrower extends AbstractTreeGrower {
	...
	public boolean growTree(World world, Random rand, int x, int y, int z, boolean isWorldGen) {
		...
		if (heightLimit == 0) {
			heightLimit = 12 + rand.nextInt(10);
		}
	...
	void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, int blockID, int metadata, boolean isWorldGen) {
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
			...
			while (var13 <= var7) {
				...
				if (var15 > par4 * par4) {
					...
					if (block == null || block.isLeafBlock(this.worldObj, var11[0], var11[1], var11[2])) {
						this.setBlockAndMetadata(worldObj, var11[0], var11[1], var11[2], blockID, metadata, isWorldGen);
					}
					++var13;
				}
			}
	 ...
	 */
	void generateLeafNode(int par1, int par2, int par3, boolean isWorldGen) {
		int var4 = par2;
	 ...
	 */
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int blockID, int metadata, boolean isWorldGen) {
		...
		if (var4[var6] != 0) {
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
				...
				this.setBlockAndMetadata(worldObj, var14[0], var14[1], var14[2], blockID, metadata | var17, isWorldGen);
			}
		}
	}
	 ...
	 */
	void generateLeaves(boolean isWorldGen) {
		int var1 = 0;
	 ...
	 */
	void generateTrunk(boolean isWorldGen) {
		int var1 = basePos[0];
		int var2 = basePos[1];
		...
		this.setBlockAndMetadata(this.worldObj, var1, var2, var4, this.woodType.stumpBlockID, this.woodType.stumpMetadata, isWorldGen);
		...
		if (trunkSize == 2) {
			...
			this.setBlockAndMetadata(this.worldObj, var1 + 1, var2, var4 + 1, this.woodType.stumpBlockID, this.woodType.stumpMetadata, isWorldGen);
			this.setBlockAndMetadata(this.worldObj, var1, var2, var4 + 1, this.woodType.stumpBlockID, this.woodType.stumpMetadata, isWorldGen);
			this.setBlockAndMetadata(this.worldObj, var1 + 1, var2, var4, this.woodType.stumpBlockID, this.woodType.stumpMetadata, isWorldGen);
		}
	}
	 ...
	 */
	void generateLeafNodeBases(boolean isWorldGen) {
		int var1 = 0;
