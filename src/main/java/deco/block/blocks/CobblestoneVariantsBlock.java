...
public class CobblestoneVariantsBlock extends Block {
	public CobblestoneVariantsBlock(int blockID) {
	...
	public void registerIcons(IconRegister register) {
		...
		for (int i = 0; i < iconArray.length; i++) {
			iconArray[i] = register.registerIcon("decoBlock" + StoneVariantsBlock.namesCapital[i] + "Cobble");
		}
	}
}
