...
public class HedgeMouldingBlock extends MouldingAndDecorativeWallBlock {
	private final boolean shouldColor;
	private final Block referenceBlock;
	private final int referenceMetadata;
	
	public HedgeMouldingBlock(int blockID, String textureName, String columnSideTextureName, int matchingCornerBlockID, Block referenceBlock,
			int referenceMetadata, String name, boolean shouldColor)
	{
		super(blockID, referenceBlock.blockMaterial, textureName, columnSideTextureName, matchingCornerBlockID, referenceBlock.blockHardness,
				referenceBlock.blockResistance, referenceBlock.stepSound, name);
