...
public class LooseStoneBrickVariantsBlock extends LavaReceiverBlock {
	protected int stoneType;
	protected String lavaOverlayTexture;
	
	public LooseStoneBrickVariantsBlock(int blockID, int stoneType, String lavaOverlayTexture) {
	...
	public boolean onMortarApplied(World world, int i, int j, int k) {
		world.setBlockAndMetadataWithNotify(i, j, k, DecoBlocks.stoneBrickVariants.blockID, this.stoneType);
		return true;
	}
