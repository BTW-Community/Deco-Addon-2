...
public class HedgeStairsBlock extends StairsBlock {
	private final boolean shouldColor;
	
	public HedgeStairsBlock(int blockID, Block referenceBlock, int referenceBlockMetadata, boolean shouldColor) {
	...
	public int colorMultiplier(IBlockAccess blockAccess, int x, int y, int z) {
		...
		if ((this.referenceBlockMetadata & 3) == 1) {
			return ColorizerFoliage.getFoliageColorPine();
		}
		else if ((this.referenceBlockMetadata & 3) == 2) {
