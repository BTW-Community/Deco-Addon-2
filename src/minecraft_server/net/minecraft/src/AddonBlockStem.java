...
public class AddonBlockStem extends AddonBlockDirectional {
	private int barkMeta;
	private int damagedLogID;
	
	protected AddonBlockStem(int id, String[] topTextures, String[] sideTextures, int barkMeta, int damagedLogID) {
