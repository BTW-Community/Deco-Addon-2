...
public class AddonBlockLogCherry extends Block {
	public AddonBlockLogCherry(int id) {
	...
	public boolean ConvertBlock(ItemStack var1, World var2, int var3, int var4, int var5, int var6)
	{
		...
		var2.setBlockAndMetadataWithNotify(var3, var4, var5, AddonDefs.logDamagedCherry.blockID, var10);
