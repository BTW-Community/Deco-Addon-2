...
public class AddonItemInWorldManager extends ItemInWorldManager {
	public AddonItemInWorldManager(World par1World) {
		super(par1World);
	}
    ...
    public boolean SurvivalTryHarvestBlock(int var1, int var2, int var3, int var4)
    {
        ...
        else
        {
            ...
            if (!var11)
            {
                ...
                if (var10)
                {
                    this.theWorld.playAuxSFXAtEntity(this.thisPlayerMP, AddonManager.addonCustomBlockConvertAuxFXID, var1, var2, var3, var5 + (var7 << 12));
            ...
            if (var9)
            {
                this.theWorld.playAuxSFXAtEntity(this.thisPlayerMP, AddonManager.addonCustomBlockBreakAuxFXID, var1, var2, var3, var5 + (var7 << 12));
