...
public class AddonItemPainting extends ItemHangingEntity {
	public AddonItemPainting(int id) {
		super(id, AddonEntityPainting.class);
	}
    ...
    {
        return new AddonEntityPainting(world, x, y, z, par5);
    }
}