...
public class AddonBlockLeavesCherry extends BlockLeavesBase
{
                ...
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == Block.leaves.blockID || var12 == this.blockID)
                        {
                            ...
                            par1World.setBlockMetadataWithNotify(par2 + var9, par3 + var10, par4 + var11, var13 | 8);
                        }
                    }
                }
            }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (!par1World.isRemote)
        {
            ...
            if ((var6 & 8) != 0 && (var6 & 4) == 0)
            {
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                if (var15 == Block.wood.blockID || var15 == AddonDefs.cherryLog.blockID)
                                {
                ...
                if (var12 >= 0)
                {
                    par1World.setBlockMetadataWithNotify(par2, par3, par4, var6 & -9);
                }
                else
                {
    ...
    {
        return AddonDefs.cherrySapling.blockID;
    }
    ...
    {
        if (!par1World.isRemote && par2EntityPlayer.getCurrentEquippedItem() != null && (par2EntityPlayer.getCurrentEquippedItem().itemID == Item.shears.itemID || par2EntityPlayer.getCurrentEquippedItem().itemID == AddonDefs.shearsDiamond.itemID))
        {
