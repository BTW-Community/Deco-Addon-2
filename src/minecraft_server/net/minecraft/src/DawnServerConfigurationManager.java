...
public class DawnServerConfigurationManager extends ServerConfigurationManager {
    ...
    {	
        ...
        NetServerHandler var7 = new DawnNetServerHandler(this.mcServer, par1INetworkManager, par2EntityPlayerMP);
        ...
        DawnAddonHandler.serverPlayerConnectionInitialized(var7, par2EntityPlayerMP);
    }
