...
public class AddonItemBlockSlabLoose extends FCItemBlockSlab {
	public AddonItemBlockSlabLoose(int var1) {
		super(var1);
	}
    ...
    public boolean attemptToCombineWithBlock(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7, boolean var8)
    {
        if (this.canCombineWithBlock(var3, var4, var5, var6, var1.getItemDamage()))
        {
            ...
            if (var10 != null && var10 instanceof AddonBlockStoneLooseSlab)
            {
            	AddonBlockStoneLooseSlab var11 = (AddonBlockStoneLooseSlab)var10;
    ...
    public boolean canCombineWithBlock(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (var6 == this.getBlockID())
        {
            ...
            {
                int var8 = ((AddonBlockStoneLooseSlab)var7).SetIsUpsideDown(var1.getBlockMetadata(var2, var3, var4), false);
