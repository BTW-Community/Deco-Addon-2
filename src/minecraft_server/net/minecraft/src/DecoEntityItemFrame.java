...
public class DecoEntityItemFrame extends EntityItemFrame {
	public DecoEntityItemFrame(World world) {
		super(world);
	}

	public DecoEntityItemFrame(World world, int x, int y, int z, int par5) {
        ...
        else
        {
            if (!this.isDead && !this.worldObj.isRemote)
            {
            	if (getDisplayedItem() != null) {
                	...
                	this.worldObj.playAuxSFX(DecoManager.decoItemFrameRemoveItemAuxFXID, this.xPosition, this.yPosition, this.zPosition, 0);
                    this.setDisplayedItem(null);
            	}
            	else {
                	this.worldObj.playAuxSFX(DecoManager.decoItemFrameBreakAuxFXID, this.xPosition, this.yPosition, this.zPosition, 0);
            		this.setDead();
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        if (this.getDisplayedItem() == null)
        {
            ...
            if (var2 != null && !this.worldObj.isRemote)
            {
            	...
            	this.worldObj.playAuxSFX(DecoManager.decoItemFrameAddItemAuxFXID, this.xPosition, this.yPosition, this.zPosition, 0);
        ...
        else if (!this.worldObj.isRemote)
        {
        	...
        	this.worldObj.playAuxSFX(DecoManager.decoItemFrameRotateItemAuxFXID, this.xPosition, this.yPosition, this.zPosition, 0);
        }
