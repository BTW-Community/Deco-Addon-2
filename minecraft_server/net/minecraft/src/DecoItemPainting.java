...
public class DecoItemPainting extends ItemHangingEntity {
	public DecoItemPainting(int id) {
		super(id, DecoEntityPainting.class);
	}
            ...
            else
            {
                if (entityHanging != null && entityHanging.onValidSurface())
                {
                    if (!world.isRemote)
                    {
                    	...
                    	world.playAuxSFX(DecoManager.decoPaintingPlaceAuxFXID, entityHanging.xPosition, entityHanging.yPosition, entityHanging.zPosition, 0);
                    }
    ...
    {
        return (EntityHanging) EntityList.createEntityOfType(DecoEntityPainting.class, world, x, y, z, par5);
    }
}