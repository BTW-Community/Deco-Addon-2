...
public class DecoBlockSaplingAcacia extends BlockFlower
{
    ...
    public static final String[] m_sBaseTextureNames = new String[] {"decoBlockSaplingAcacia_0"};

    protected DecoBlockSaplingAcacia(int var1)
    {
        super(var1);
        float var2 = 0.4F;
