...
public class DecoItemBlockLog extends FCItemBlockLog
{
    public DecoItemBlockLog(int var1, Block var2, String[] var3)
    {
    ...
    public void OnUsedInCrafting(int var1, EntityPlayer var2, ItemStack var3)
    {
        ...
        {
            if (var3.itemID == DecoDefs.strippedLog.blockID || var3.itemID == DecoDefs.barkLogStripped.blockID)
            {
