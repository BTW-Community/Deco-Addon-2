...
public class DecoItemBlockWoodCornerStub extends ItemBlock
{
    public DecoItemBlockWoodCornerStub(int var1)
    {
        super(var1);
    ...
    {
        return DecoBlockPlanks.GetFurnaceBurnTimeByWoodType(var1) / 8;
    }
}
