...
public class DecoItemFrame extends ItemHangingEntity {

	public DecoItemFrame(int id) {
		super(id, DecoItemFrame.class);
	}
            ...
            else
            {
                if (entityHanging != null && entityHanging.onValidSurface())
                {
                    if (!world.isRemote)
                    {
                    	...
                    	world.playAuxSFX(DecoManager.decoItemFramePlaceAuxFXID, entityHanging.xPosition, entityHanging.yPosition, entityHanging.zPosition, 0);
                    }
