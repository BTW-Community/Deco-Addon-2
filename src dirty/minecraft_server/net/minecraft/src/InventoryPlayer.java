...
public class InventoryPlayer implements IInventory
{
    ...
    public float getStrVsBlock(World var1, Block var2, int var3, int var4, int var5)
    {
        ...
        {
            var6 *= this.mainInventory[this.currentItem].getStrVsBlock(var1, var2, var3, var4, var5);
        }
    ...
    {
        if (var2.blockMaterial.isToolNotRequired())
        {
            return true;
        }
        else
        {
            ItemStack var6 = this.getStackInSlot(this.currentItem);
            return var6 != null ? var6.canHarvestBlock(var1, var2, var3, var4, var5) : false;
        }
    }
