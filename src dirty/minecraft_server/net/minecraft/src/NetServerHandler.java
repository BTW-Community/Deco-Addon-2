...
public class NetServerHandler extends NetHandler
{
            ...
            if (this.hasMoved)
            {
                ...
                if (par1Packet10Flying.moving)
                {
                    ...
                    if (!this.playerEntity.isPlayerSleeping() && (var11 > 1.65D || var11 < 0.1D))
                    {
                        ...
                        this.mcServer.getLogAgent().func_98236_b(this.playerEntity.username + " had an illegal stance: " + var11);
                        return;
                    }
                ...
                {
                    this.mcServer.getLogAgent().func_98236_b(this.playerEntity.username + " moved too quickly! " + var11 + "," + var15 + "," + var17 + " (" + var19 + ", " + var21 + ", " + var23 + ")");
    ...
    public void handleClientInfo(Packet204ClientInfo par1Packet204ClientInfo)
    {
        ...
        if (!par1Packet204ClientInfo.IsBTWInstalled())
        {
            ...
            this.playerEntity.playerNetServerHandler.sendPacket(new Packet3Chat("\u00a74" + "This server requires all clients to have Better Than Wolves version " + "4.B0000002"));
            this.mcServer.getLogAgent().func_98233_a(this.playerEntity.username + " logged in without BTW installed");
        }
    }
