...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        {
            this.fillWithBlocks(par1World, par3StructureBoundingBox, var5, var5, var5, this.scatteredFeatureSizeX - 1 - var5, var5, this.scatteredFeatureSizeZ - 1 - var5, Block.sandStone.blockID, Block.sandStone.blockID, false);
        ...
        for (var5 = 0; var5 < this.scatteredFeatureSizeX; ++var5)
        {
            ...
            {
                this.fillCurrentPositionBlocksDownwards(par1World, Block.sandStone.blockID, 0, var5, -5, var6, par3StructureBoundingBox);
            }
        }
        ...
        {
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, 4, 1, var9, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, 4, 2, var9, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, this.scatteredFeatureSizeX - 5, 1, var9, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, this.scatteredFeatureSizeX - 5, 2, var9, par3StructureBoundingBox);
        }
        ...
        {
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 2, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 2, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 2, 3, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 3, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 3, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 3, 3, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 4, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, var9, 4, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 4, 3, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 5, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 5, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 5, 3, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 6, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, var9, 6, 2, par3StructureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 8, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 8, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 8, 3, par3StructureBoundingBox);
        }

        for (var9 = 2; var9 <= this.scatteredFeatureSizeX - 3; var9 += this.scatteredFeatureSizeX - 3 - 2)
        {
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 - 1, 2, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9, 2, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 + 1, 2, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 - 1, 3, 0, par3StructureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, var9, 4, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9 + 1, 4, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 - 1, 5, 0, par3StructureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, var9, 6, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9 + 1, 6, 0, par3StructureBoundingBox);
            ...
            this.placeBlockAtCurrentPosition(par1World, Block.obsidian.blockID, 0, var9 + 1, 7, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 - 1, 8, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9, 8, 0, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, var9 + 1, 8, 0, par3StructureBoundingBox);
        }
