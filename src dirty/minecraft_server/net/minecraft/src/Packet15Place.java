...
public class Packet15Place extends Packet
{
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        this.xOffset = (float)par1DataInputStream.readShort() / 32000.0F;
        this.yOffset = (float)par1DataInputStream.readShort() / 32000.0F;
        this.zOffset = (float)par1DataInputStream.readShort() / 32000.0F;
    }
