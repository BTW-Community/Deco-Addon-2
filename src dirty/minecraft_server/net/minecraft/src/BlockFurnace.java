...
public class BlockFurnace extends BlockContainer
{
    ...
    public void updateFurnaceBlockState(boolean var1, World var2, int var3, int var4, int var5, boolean var6)
    {
        ...
        if (var1)
        {
            var2.setBlock(var3, var4, var5, Block.furnaceBurning.blockID);
        }
        else
        {
            var2.setBlock(var3, var4, var5, Block.furnaceIdle.blockID);
        }
        ...
        var2.setBlockMetadata(var3, var4, var5, var7, 2);
