...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            if (var17 == this.inTile && (var3 == this.inData || var17 == FCBetterThanWolves.fcBlockDetector.blockID))
            {
                ++this.ticksInGround;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var24 = DamageSource.causeArrowDamage(this, this);
                    }
                    else
                    {
                        var24 = DamageSource.causeArrowDamage(this, this.shootingEntity);
                    }
                    ...
                    if (var4.entityHit.attackEntityFrom(var24, (int)((float)var23 * this.GetDamageMultiplier())))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            if (this.knockbackStrength > 0)
                            {
                                ...
                                if (var22 > 0.0F)
                                {
                                    var4.entityHit.addVelocity(this.motionX * (double)this.knockbackStrength * 0.6000000238418579D / (double)var22, 0.1D, this.motionZ * (double)this.knockbackStrength * 0.6000000238418579D / (double)var22);
                                }
                            }
                ...
                else
                {
                    ...
                    this.NotifyColldingBlockOfImpact();
    ...
    {
        return var1.inventory.addItemStackToInventory(new ItemStack(this.GetCorrespondingItem(), 1));
    }
    ...
    private void NotifyAnyCollidingBlocks()
    {
        if (this.inGround)
        {
            Block var1 = Block.blocksList[this.inTile];

            if (var1 != null)
            {
                var1.OnArrowCollide(this.worldObj, this.xTile, this.yTile, this.zTile, this);
            }
        }
    }
    ...
    private void NotifyColldingBlockOfImpact()
    {
        ...
        if (var1 != null)
        {
            var1.OnArrowImpact(this.worldObj, this.xTile, this.yTile, this.zTile, this);
        }
    }
}
