...
public class MerchantRecipe
{
    ...
    public void readFromTags(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            this.m_iTradeLevel = par1NBTTagCompound.getInteger("fcTradeLevel");
        }
        else
        {
    ...
    public NBTTagCompound writeToTags()
    {
        ...
        var1.setInteger("fcTradeLevel", this.m_iTradeLevel);
        return var1;
    }

    public MerchantRecipe(ItemStack var1, ItemStack var2, ItemStack var3, int var4)
    {
        this(var1, var2, var3);
        this.m_iTradeLevel = var4;
    }

    public MerchantRecipe(ItemStack var1, ItemStack var2, int var3)
    {
        this(var1, (ItemStack)null, var2, var3);
    }

    public MerchantRecipe(ItemStack var1, Item var2, int var3)
    {
        this(var1, new ItemStack(var2), var3);
    }
}
