...
public class EntityAITasks
{
    ...
    public void RemoveAllTasksOfClass(Class var1)
    {
        Iterator var2 = this.taskEntries.iterator();
    ...
    {
        for (Iterator var1 = this.taskEntries.iterator(); var1.hasNext(); var1.remove())
        {
            EntityAITaskEntry var2 = (EntityAITaskEntry)var1.next();

            if (this.executingTaskEntries.contains(var2))
            {
