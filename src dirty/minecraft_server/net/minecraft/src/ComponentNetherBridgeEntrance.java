...
public class ComponentNetherBridgeEntrance extends ComponentNetherBridgePiece
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockSoulforgeDormant.blockID, FCUtilsWorld.RotateFacingForCoordBaseMode(4, this.coordBaseMode), 5, 6, 6, par3StructureBoundingBox);
        return true;
    }
}
