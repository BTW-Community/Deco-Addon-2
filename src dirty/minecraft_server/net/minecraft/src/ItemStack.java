...
public final class ItemStack
{
    ...
    {
        if ((!(par2EntityLiving instanceof EntityPlayer) || !((EntityPlayer)par2EntityLiving).capabilities.isCreativeMode) && this.isItemStackDamageable() && this.func_96631_a(par1, par2EntityLiving.getRNG()))
        {
