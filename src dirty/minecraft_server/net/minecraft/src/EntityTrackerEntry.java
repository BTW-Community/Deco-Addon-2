...
public class EntityTrackerEntry
{
    ...
    {
        return par1EntityPlayerMP.getServerForPlayer().GetChunkTracker().IsChunkWatchedByPlayerAndSentToClient(par1EntityPlayerMP, this.trackedEntity.chunkCoordX, this.trackedEntity.chunkCoordZ);
    }
        ...
        else if (!(this.trackedEntity instanceof IAnimals) && !(this.trackedEntity instanceof EntityDragon))
        {
            ...
            else
            {
                ...
                if (this.trackedEntity instanceof EntityFireball)
                {
                    ...
                    {
                        var1 = new Packet23VehicleSpawn(this.trackedEntity, var3, ((EntityFireball)this.trackedEntity).shootingEntity.entityId);
                    }
                    else
                    {
                        var1 = new Packet23VehicleSpawn(this.trackedEntity, var3, 0);
                    }
                ...
                else if (this.trackedEntity instanceof EntityItemFrame)
                {
                    ...
                    var1 = new Packet23VehicleSpawn(this.trackedEntity, 71, var2.hangingDirection);
