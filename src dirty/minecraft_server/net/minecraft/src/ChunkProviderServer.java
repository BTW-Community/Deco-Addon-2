...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    {
        return this.serverChunkGenerator;
    }

    protected boolean IsSpawnChunk(int var1, int var2)
    {
        if (!this.worldObj.provider.canRespawnHere())
        {
            return false;
        ...
        else
        {
            ...
            int var4 = this.worldObj.worldInfo.getSpawnX() >> 4;
            int var5 = this.worldObj.worldInfo.getSpawnZ() >> 4;
            int var6 = this.worldObj.getMinecraftServer().getConfigurationManager().getViewDistance();
            return var1 >= var4 - var6 && var1 <= var4 + var6 && var2 >= var5 - var6 && var2 <= var5 + var6;
        }
    }

    public void ForceAddToChunksToUnload(int var1, int var2)
    {
