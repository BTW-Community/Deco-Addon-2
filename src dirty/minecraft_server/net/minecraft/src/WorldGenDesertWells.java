...
public class WorldGenDesertWells extends WorldGenerator
{
    ...
    {
        m_LootBasketContents = new FCUtilsRandomItemStack[] {new FCUtilsRandomItemStack(FCBetterThanWolves.fcItemHempSeeds.itemID, 0, 1, 4, 5), new FCUtilsRandomItemStack(Item.glassBottle.itemID, 0, 2, 8, 10)};
    }

    private void AddModBlocks(World var1, int var2, int var3, int var4)
    {
        int var5 = var1.rand.nextInt(3);

        for (int var6 = 0; var6 < var5; ++var6)
        {
            int var7 = var2 + (var1.rand.nextInt(2) == 0 ? -2 : 2);
            int var8 = var3 + 2;
            int var9 = var4 + (var1.rand.nextInt(2) == 0 ? -2 : 2);
            this.AddLootBasket(var1, var7, var8, var9);
        }
    }

    private void AddLootBasket(World var1, int var2, int var3, int var4)
    {
        ...
        if (var1.getBlockId(var2, var3, var4) != FCBetterThanWolves.fcBlockBasketWicker.blockID)
        {
            var1.setBlock(var2, var3, var4, FCBetterThanWolves.fcBlockBasketWicker.blockID, var1.rand.nextInt(4) | 4, 2);
            FCTileEntityBasketWicker var5 = (FCTileEntityBasketWicker)var1.getBlockTileEntity(var2, var3, var4);

            if (var5 != null)
            {
                var5.SetStorageStack(FCUtilsRandomItemStack.GetRandomStack(var1.rand, m_LootBasketContents));
            }
        }
    }
}
