...
public class WorldInfo
{
    ...
    {
        return this.m_globalEnderChestInventory;
    }

    private void LoadModInfoFromNBT(NBTTagCompound var1)
    {
        if (var1.hasKey("FCEnderItems"))
        {
            NBTTagList var2 = var1.getTagList("FCEnderItems");
            this.m_globalEnderChestInventory.loadInventoryFromNBT(var2);
        }

        if (var1.hasKey("FCNetherAccessed"))
        {
            this.m_bHasNetherBeenAccessed = var1.getBoolean("FCNetherAccessed");
        }

        if (var1.hasKey("FCWitherSummoned"))
        {
            this.m_bHasWitherBeenSummoned = var1.getBoolean("FCWitherSummoned");
        }

        if (var1.hasKey("FCEndAccessed"))
        {
            this.m_bHasEndDimensionBeenAccessed = var1.getBoolean("FCEndAccessed");
        }

        this.m_bPreviouslyRaining = this.raining;
        this.m_bPreviouslyThundering = this.thundering;
    }

    private void SaveModInfoToNBT(NBTTagCompound var1)
    {
        if (this.m_globalEnderChestInventory != null)
        {
            var1.setTag("FCEnderItems", this.m_globalEnderChestInventory.saveInventoryToNBT());
        }

        var1.setBoolean("FCNetherAccessed", this.m_bHasNetherBeenAccessed);
        var1.setBoolean("FCWitherSummoned", this.m_bHasWitherBeenSummoned);
        var1.setBoolean("FCEndAccessed", this.m_bHasEndDimensionBeenAccessed);
    }

    private void CopyModInfo(WorldInfo var1)
    {
        if (var1.m_globalEnderChestInventory != null)
        {
            this.m_globalEnderChestInventory = var1.m_globalEnderChestInventory;
        }

        this.m_bHasNetherBeenAccessed = var1.m_bHasNetherBeenAccessed;
        this.m_bHasWitherBeenSummoned = var1.m_bHasWitherBeenSummoned;
        this.m_bHasEndDimensionBeenAccessed = var1.m_bHasEndDimensionBeenAccessed;
        this.m_bPreviouslyRaining = this.raining;
        this.m_bPreviouslyThundering = this.thundering;
    }
    ...
    {
        return this.m_bHasNetherBeenAccessed;
    }

    public void SetNetherBeenAccessed()
    {
        this.m_bHasNetherBeenAccessed = true;
    }

    public boolean HasWitherBeenSummoned()
    {
        return this.m_bHasWitherBeenSummoned;
    }

    public void SetWitherHasBeenSummoned()
    {
        this.m_bHasWitherBeenSummoned = true;
    }

    public boolean HasEndDimensionBeenAccessed()
    {
        return this.m_bHasEndDimensionBeenAccessed;
    }

    public void SetEndDimensionHasBeenAccessed()
    {
        this.m_bHasEndDimensionBeenAccessed = true;
    }
}
