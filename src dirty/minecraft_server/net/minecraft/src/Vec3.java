...
public class Vec3
{
    ...
    public static Vec3 createVectorHelper(Vec3 var0)
    {
        return new Vec3(fakePool, var0.xCoord, var0.yCoord, var0.zCoord);
    }

    public void RotateAsBlockPosAroundJToFacing(int var1)
    {
        if (var1 > 2)
        {
            double var2;
            ...
            {
                var2 = this.xCoord;
                this.xCoord = 1.0D - this.zCoord;
                this.zCoord = var2;
            }
            else if (var1 == 4)
            {
                var2 = 1.0D - this.xCoord;
                this.xCoord = this.zCoord;
                this.zCoord = var2;
            }
            else
            {
                this.xCoord = 1.0D - this.xCoord;
                this.zCoord = 1.0D - this.zCoord;
            }
        }
    }

    public void RotateAsVectorAroundJToFacing(int var1)
    {
        if (var1 > 2)
        {
            double var2;
    ...
    public void TiltAsBlockPosToFacingAlongJ(int var1)
    {
        if (var1 == 0)
        {
            this.yCoord = 1.0D - this.yCoord;
            this.xCoord = 1.0D - this.xCoord;
        }
        else
        {
            ...
            {
                var2 = this.yCoord;
                this.yCoord = 1.0D - this.zCoord;
                this.zCoord = var2;
            }
            else if (var1 == 4)
            {
                var2 = this.xCoord;
                this.xCoord = 1.0D - this.yCoord;
                this.yCoord = var2;
            }
            else if (var1 == 5)
            {
    ...
    public void TiltAsVectorToFacingAlongJ(int var1)
    {
        if (var1 == 0)
        {
    ...
    public final Vec3 SubtractFrom(Vec3 var1)
    {
        return this.subtract(var1);
    }

    public Vec3 AddVector(Vec3 var1)
    {
        return this.myVec3LocalPool.getVecFromPool(this.xCoord + var1.xCoord, this.yCoord + var1.yCoord, this.zCoord + var1.zCoord);
    }
    ...
    public double DistanceSquareFlat(Vec3 var1)
    {
        double var2 = var1.xCoord - this.xCoord;
        double var4 = var1.zCoord - this.zCoord;
