...
public class ItemInWorldManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        else if (this.isDestroyingBlock)
        {
            ...
            else
            {
                ...
                var2 = var6.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.curBlockX, this.curBlockY, this.curBlockZ) * (float)(var7 + 1);
                var3 = (int)(var2 * 10.0F);

                if (var3 != this.durabilityRemainingOnBlock)
                {
                    this.theWorld.destroyBlockInWorldPartially(this.thisPlayerMP.entityId, this.curBlockX, this.curBlockY, this.curBlockZ, var3);
                    this.durabilityRemainingOnBlock = var3;
                }
            }
        }
    ...
    {
        this.blockRemoving(par1, par2, par3, 1);
    }

    public void blockRemoving(int var1, int var2, int var3, int var4)
    {
