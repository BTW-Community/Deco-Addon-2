...
public class CommandTime extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        {
            par1ICommandSender.sendChatToPlayer("\u00a7e" + "Current Overworld Time: " + Long.valueOf(MinecraftServer.getServer().worldServers[0].getWorldTime()) + " Total Overworld Time: " + Long.valueOf(MinecraftServer.getServer().worldServers[0].getTotalWorldTime()));
        }
    }
