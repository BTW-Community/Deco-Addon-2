...
public class ItemArmor extends Item
{
    ...
    {
        return var1.type == EnumEnchantmentType.armor ? true : (var1.type == EnumEnchantmentType.armor_head ? this.armorType == 0 : (var1.type == EnumEnchantmentType.armor_torso ? this.armorType == 1 : (var1.type == EnumEnchantmentType.armor_legs ? this.armorType == 2 : (var1.type == EnumEnchantmentType.armor_feet ? this.armorType == 3 : super.IsEnchantmentApplicable(var1)))));
    }
}
