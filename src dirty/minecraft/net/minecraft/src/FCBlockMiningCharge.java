...
public class FCBlockMiningCharge extends Block
{
    ...
    {
        this.m_IconBottom = var1.registerIcon("fcBlockMiningCharge_bottom");
        this.m_IconTop = var1.registerIcon("fcBlockMiningCharge_top");
        this.m_IconSide = var1.registerIcon("fcBlockMiningCharge_side");
        this.m_IconSideFlipped = var1.registerIcon("fcBlockMiningCharge_side_vert");
    ...
    {
        return var1 <= 3 ? this.m_IconSideFlipped : (var1 == 4 ? this.m_IconTop : this.m_IconBottom);
    }
    ...
    {
        int var6 = this.GetFacing(var1, var2, var3, var4);
        return var6 <= 1 ? (var5 <= 3 ? this.m_IconSideFlipped : (var5 == 4 ? this.m_IconTop : this.m_IconBottom)) : (var5 == 0 ? this.m_IconBottom : (var5 == 1 ? this.m_IconTop : this.m_IconSide));
    }

    public Icon getBlockTextureFromMetadataCustom(int var1, int var2)
    {
        int var3 = this.GetFacing(var2);
        return var3 <= 1 ? (var1 <= 3 ? this.m_IconSideFlipped : (var1 == 4 ? this.m_IconTop : this.m_IconBottom)) : (var1 == 0 ? this.m_IconBottom : (var1 == 1 ? this.m_IconTop : this.m_IconSide));
    }
