    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            if (this.isLargeRoom)
            {
                ...
                int var6 = this.getMetadataWithOffset(Block.ladder.blockID, 3);
                int var7 = FCBetterThanWolves.fcBlockLadder.SetFacing(0, var6);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 1, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 2, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 3, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 4, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 5, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 6, 13, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var7, 10, 7, 13, par3StructureBoundingBox);
                byte var8 = 7;
                byte var9 = 7;
