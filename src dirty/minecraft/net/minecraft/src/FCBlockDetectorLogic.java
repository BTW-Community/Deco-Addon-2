...
public class FCBlockDetectorLogic extends Block
{
    ...
    private boolean IsEntityWithinBounds(World var1, int var2, int var3, int var4)
    {
        ...
        if (var5 != null && var5.size() > 0)
        {
            for (int var6 = 0; var6 < var5.size(); ++var6)
            {
                ...
                if (!(var7 instanceof EntityFX) && !(var7 instanceof FCEntityBlockLiftedByPlatform))
                {
                    return true;
                }
            }
    ...
    {
        this.blockIcon = var1.registerIcon("fcBlockLens_spotlight");
    }
    ...
    public boolean RenderDetectorLogicDebug(RenderBlocks var1, IBlockAccess var2, int var3, int var4, int var5, Block var6)
    {
        return true;
    }

    public void RenderDetectorLogicDebugInvBlock(RenderBlocks var1, Block var2, int var3, int var4) {}
}
