...
public class PathNavigate
{
    ...
    private void pathFollow()
    {
        ...
        for (var3 = this.currentPath.getCurrentPathIndex(); var3 < this.currentPath.getCurrentPathLength(); ++var3)
        {
        ...
        for (var3 = this.currentPath.getCurrentPathIndex(); var3 < var2; ++var3)
        {
            Vec3 var4 = this.currentPath.getVectorFromIndex(this.theEntity, var3);

            if (Math.abs(var1.xCoord - var4.xCoord) < 0.49D && Math.abs(var1.zCoord - var4.zCoord) < 0.49D && Math.abs(var1.yCoord - var4.yCoord) < 0.49D)
            {
                this.currentPath.setCurrentPathIndex(var3 + 1);
            }
        }

        var3 = MathHelper.ceiling_float_int(this.theEntity.width);
        int var7 = (int)this.theEntity.height + 1;
        int var5 = var3;

        for (int var6 = var2 - 1; var6 >= this.currentPath.getCurrentPathIndex(); --var6)
        {
            if (this.isDirectPathBetweenPoints(var1, this.currentPath.getVectorFromIndex(this.theEntity, var6), var3, var7, var5))
            {
                this.currentPath.setCurrentPathIndex(var6);
                break;
            }
        }
    ...
    public boolean tryMoveToXYZ(int var1, int var2, int var3, float var4)
    {
        PathEntity var5 = this.getPathToXYZ(var1, var2, var3);
        return this.setPath(var5, var4);
    }

    public PathEntity getPathToXYZ(int var1, int var2, int var3)
    {
        return this.canNavigate() ? this.worldObj.getEntityPathToXYZ(this.theEntity, var1, var2, var3, this.pathSearchRange, this.canPassOpenWoodenDoors, this.canPassClosedWoodenDoors, this.avoidsWater, this.canSwim) : null;
    }

    public PathEntity GetPathToEntity(Entity var1)
    {
    ...
    public boolean TryMoveToEntity(Entity var1, float var2)
    {
        PathEntity var3 = this.GetPathToEntity(var1);
