...
public class FCClientRenderWaterWheel extends Render
{
    ...
    public FCClientRenderWaterWheel()
    {
        ...
        this.modelWaterWheel = new FCClientModelWaterWheel();
    }
    ...
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9)
    {
        ...
        {
            FCEntityWaterWheel var13 = (FCEntityWaterWheel)var1;
            GL11.glPushMatrix();
            GL11.glTranslatef((float)var2, (float)var4, (float)var6);
            this.loadTexture("/btwmodtex/fcwaterwheelent.png");
            ...
            this.modelWaterWheel.render(var1, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
            GL11.glPopMatrix();
        }
    }
}
