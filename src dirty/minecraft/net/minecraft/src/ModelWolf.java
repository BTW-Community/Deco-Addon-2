...
public class ModelWolf extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4)
    {
        ...
        this.wolfHeadMain.rotationPointY = 13.5F + ((FCEntityWolf)par1EntityLiving).GetGrazeHeadVerticalOffset(par4) * 5.0F;
        this.m_fHeadRotation = ((FCEntityWolf)par1EntityLiving).GetGrazeHeadRotation(par4);
        this.wolfHeadMain.rotateAngleZ += var5.GetPossessionHeadRotation();
    }
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
    {
        ...
        this.wolfHeadMain.rotateAngleX = this.m_fHeadRotation;
    }
}
