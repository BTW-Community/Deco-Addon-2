...
public class FurnaceRecipes
{
    ...
    {
        this.addSmelting(par1, par2ItemStack, par3, 0);
    }

    public void addSmelting(int var1, ItemStack var2, float var3, int var4)
    {
        this.smeltingList.put(Integer.valueOf(var1), var2);
        this.experienceList.put(Integer.valueOf(var2.itemID), Float.valueOf(var3));
        this.m_CookTimeBinaryShiftMap.put(Integer.valueOf(var1), Integer.valueOf(var4));
    }

    public int GetCookTimeBinaryShift(int var1)
    {
        return this.m_CookTimeBinaryShiftMap.containsKey(Integer.valueOf(var1)) ? ((Integer)this.m_CookTimeBinaryShiftMap.get(Integer.valueOf(var1))).intValue() : 0;
    }
}
