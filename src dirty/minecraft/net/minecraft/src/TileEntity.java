...
public class TileEntity
{
    ...
    public static void ReplaceVanillaMapping(Class var0, Class var1, String var2)
    {
        removeTileEntityMapping(var0, var2);
        addMapping(var1, var2);
    }

    public static void removeTileEntityMapping(Class var0, String var1)
    {
        nameToClassMap.remove(var1);
        classToNameMap.remove(var0);
    }
