...
public class TileEntityRenderer
{
    ...
    private TileEntityRenderer()
    {
        ...
        this.specialRendererMap.put(FCTileEntityCampfire.class, new FCTileEntityCampfireRenderer());
        this.specialRendererMap.put(FCTileEntityFurnaceBrick.class, new FCTileEntityFurnaceBrickRenderer());
