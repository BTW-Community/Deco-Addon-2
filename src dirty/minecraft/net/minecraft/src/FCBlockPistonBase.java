...
public class FCBlockPistonBase extends BlockPistonBase
{
    ...
    public Icon getIcon(int var1, int var2)
    {
        ...
        return var3 > 5 ? this.topIcon : (var1 == var3 ? (!m_bIsRenderingExtendedBase ? this.topIcon : this.innerTopIcon) : (var1 == GetOppositeFacing(var3) ? this.bottomIcon : this.blockIcon));
    }

    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        var1.setRenderBounds(this.GetBlockBoundsFromPoolBasedOnState(var1.blockAccess, var2, var3, var4));
        return var1.renderPistonBase(this, var2, var3, var4, false);
    }
