...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        double var1 = (double)(this.attacker.width + this.entityTarget.width);
        double var3 = var1 * var1;

        if (this.entityTarget != this.attacker.riddenByEntity)
        {
            if (this.attacker.getDistanceSq(this.entityTarget.posX, this.entityTarget.boundingBox.minY, this.entityTarget.posZ) <= var3 && this.attackTick <= 0)
            {
                this.attackTick = 20;
