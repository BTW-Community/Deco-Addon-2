...
public class FCBlockPulley extends BlockContainer implements FCIBlockMechanical
{
    ...
    {
        Icon var2 = var1.registerIcon("fcBlockPulley_side");
        this.blockIcon = var2;
        this.m_IconBySideArray[0] = var1.registerIcon("fcBlockPulley_bottom");
        this.m_IconBySideArray[1] = var1.registerIcon("fcBlockPulley_top");
