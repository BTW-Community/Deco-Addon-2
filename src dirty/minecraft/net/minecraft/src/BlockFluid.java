...
public abstract class BlockFluid extends Block
{
    ...
    public static boolean bIsAnySideBeingRendered;
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (this.blockMaterial == Material.lava && par1World.getBlockMaterial(par2, par3 + 1, par4) == Material.air && !par1World.isBlockOpaqueCube(par2, par3 + 1, par4))
        {
            if (par5Random.nextInt(100) == 0)
            {
                ...
                var11 = (double)par3 + this.maxY;
                var22 = (double)((float)par4 + par5Random.nextFloat());
                par1World.spawnParticle("lava", var21, var11, var22, 0.0D, 0.0D, 0.0D);
                par1World.playSound(var21, var11, var22, "liquid.lavapop", 0.2F + par5Random.nextFloat() * 0.2F, 0.9F + par5Random.nextFloat() * 0.15F, false);
            }
        ...
        {
            var21 = (double)((float)par2 + par5Random.nextFloat());
            var11 = (double)par3 - 1.05D;
            var22 = (double)((float)par4 + par5Random.nextFloat());

            if (this.blockMaterial == Material.water)
            {
                par1World.spawnParticle("dripWater", var21, var11, var22, 0.0D, 0.0D, 0.0D);
            }
            else
            {
                par1World.spawnParticle("dripLava", var21, var11, var22, 0.0D, 0.0D, 0.0D);
            }
        }
    }
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        if (var6 != this.blockMaterial && (par5 == 1 || var6 != Material.ice && super.shouldSideBeRendered(par1IBlockAccess, par2, par3, par4, par5)))
        {
    ...
    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        ...
        return var1.renderBlockFluids(this, var2, var3, var4);
    }
}
