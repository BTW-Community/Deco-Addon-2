...
public class FCItemKnitting extends FCItemCraftingProgressive
{
    ...
    {
        return var2 == 0 ? GetColor(var1) : super.getColorFromItemStack(var1, var2);
    }

    public void registerIcons(IconRegister var1)
    {
        super.registerIcons(var1);
        this.m_iconWool = var1.registerIcon("fcItemKnitting_Wool");
    }
    ...
    {
        return var2 == 0 ? this.m_iconWool : this.itemIcon;
    }
}
