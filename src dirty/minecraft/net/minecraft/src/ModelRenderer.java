...
public class ModelRenderer
{
    ...
    public void RenderWithScaleToBaseModel(float var1, float var2, float var3, float var4)
    {
        if (!this.isHidden && this.showModel)
        {
            if (!this.compiled)
            ...
            if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
            {
                ...
                {
                    GL11.glPushMatrix();
                    GL11.glScalef(var2, var3, var4);
                    GL11.glCallList(this.displayList);

                    if (this.childModels != null)
                    {
                        for (var5 = 0; var5 < this.childModels.size(); ++var5)
                        {
