...
public class FCBlockFence extends Block
{
    ...
    {
        this.blockIcon = var1.registerIcon(this.m_sIconName);
    }
    ...
    {
        FCModelBlock var5 = this.AssembleTemporaryModel(var1.blockAccess, var2, var3, var4);
    ...
    {
        AxisAlignedBB var3 = m_model.m_boxBoundsCenter.MakeTemporaryCopy();
        return var3.offset((double)var2.blockX, (double)var2.blockY, (double)var2.blockZ);
    }
}
