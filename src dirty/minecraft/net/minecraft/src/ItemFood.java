...
public class ItemFood extends Item
{
    ...
    private boolean m_bDoZombiesConsume;

    public ItemFood(int par1, int par2, float par3, boolean par4)
    {
        super(par1);
        this.m_bDoZombiesConsume = false;
    ...
    public ItemFood(int var1, int var2, float var3, boolean var4, boolean var5)
    {
        this(var1, var2, var3, var4);
        this.m_bDoZombiesConsume = var5;
    }

    public boolean DoZombiesConsume()
    {
        return this.m_bDoZombiesConsume;
    }
