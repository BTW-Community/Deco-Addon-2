...
public class FCBlockBBQ extends Block
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_IconBySideArray[0] = var1.registerIcon("fcBlockHibachi_bottom");
        this.m_IconBySideArray[1] = var1.registerIcon("fcBlockHibachi_top");
        Icon var2 = var1.registerIcon("fcBlockHibachi_side");
