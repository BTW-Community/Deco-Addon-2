...
public abstract class FCBlockVessel extends BlockContainer implements FCIBlockMechanical
{
    ...
    private boolean m_bRenderingWideBand = false;
    ...
    {
        return this.m_bRenderingInterior ? this.m_IconInteriorBySideArray[var1] : (this.m_bRenderingWideBand ? this.m_IconWideBandBySideArray[var1] : this.m_IconCenterColumnBySideArray[var1]);
    }
    ...
    public Icon getBlockTexture(IBlockAccess var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (this.GetMechanicallyPoweredFlag(var1, var2, var3, var4))
        {
            int var7 = this.GetTiltFacing(var1, var2, var3, var4);

            if (var7 == var5)
            {
                var6 = 1;
            }
            else if (var5 == Block.GetOppositeFacing(var7))
            {
                var6 = 0;
            }
            else
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        if (!this.GetMechanicallyPoweredFlag(var1, var2, var3, var4))
        {
            ...
            if (var6 == Block.fire.blockID || var6 == FCBetterThanWolves.fcBlockFireStoked.blockID)
            {
                for (int var7 = 0; var7 < 1; ++var7)
                {
                    float var8 = (float)var2 + var5.nextFloat();
                    float var9 = (float)var3 + var5.nextFloat() * 0.5F + 1.0F;
                    float var10 = (float)var4 + var5.nextFloat();
                    var1.spawnParticle("fcwhitesmoke", (double)var8, (double)var9, (double)var10, 0.0D, 0.0D, 0.0D);
                }
            }
        }
    }
    ...
    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        ...
        this.m_bRenderingWideBand = true;
        FCClientUtilsRender.RenderBlockWithBoundsAndTextureRotation(var1, this, var2, var3, var4, var6, 0.0F, 0.125F, 0.0F, 1.0F, 0.875F, 1.0F);
        this.m_bRenderingWideBand = false;
        FCClientUtilsRender.RenderBlockWithBoundsAndTextureRotation(var1, this, var2, var3, var4, var6, 0.0625F, 0.0F, 0.0625F, 0.9375F, 1.0F, 0.9375F);
        this.m_bRenderingInterior = true;
        Tessellator var7 = Tessellator.instance;
        FCClientUtilsRender.SetRenderBoundsToBlockFacing(var1, var6, 0.0625F, 0.0F, 0.0625F, 0.9375F, 1.0F, 0.9375F);
        FCClientUtilsRender.SetTextureRotationBasedOnBlockFacing(var1, var6);
        var7.setBrightness(this.getMixedBrightnessForBlock(var5, var2, var3, var4));
        float var8 = 0.66F;
        int var9 = this.colorMultiplier(var5, var2, var3, var4);
        float var10 = (float)(var9 >> 16 & 255) / 255.0F;
        float var11 = (float)(var9 >> 8 & 255) / 255.0F;
        float var12 = (float)(var9 & 255) / 255.0F;
        var7.setColorOpaque_F(0.66F * var10, 0.66F * var11, 0.66F * var12);
        double var13 = 0.249D;
        var1.renderFaceXPos(this, (double)var2 - 1.0D + 0.249D, (double)var3, (double)var4, this.getBlockTexture(var5, var2, var3, var4, 4));
        var1.renderFaceXNeg(this, (double)var2 + 1.0D - 0.249D, (double)var3, (double)var4, this.getBlockTexture(var5, var2, var3, var4, 5));
        var1.renderFaceZPos(this, (double)var2, (double)var3, (double)var4 - 1.0D + 0.249D, this.getBlockTexture(var5, var2, var3, var4, 2));
        var1.renderFaceZNeg(this, (double)var2, (double)var3, (double)var4 + 1.0D - 0.249D, this.getBlockTexture(var5, var2, var3, var4, 3));
        var1.renderFaceYPos(this, (double)var2, (double)((float)var3 - 1.0F) + 0.249D, (double)var4, this.getBlockTexture(var5, var2, var3, var4, 0));
        var1.renderFaceYNeg(this, (double)var2, (double)((float)var3 + 1.0F) - 0.249D, (double)var4, this.getBlockTexture(var5, var2, var3, var4, 1));
    ...
    public void RenderBlockAsItem(RenderBlocks var1, int var2, float var3)
    {
        this.m_bRenderingInterior = false;
        this.m_bRenderingWideBand = true;
        var1.setRenderBounds(0.0D, 0.125D, 0.0D, 1.0D, 0.875D, 1.0D);
        FCClientUtilsRender.RenderInvBlockWithMetadata(var1, this, -0.5F, -0.5F, -0.5F, 0);
        this.m_bRenderingWideBand = false;
        var1.setRenderBounds(0.0625D, 0.0D, 0.0625D, 0.9375D, 1.0D, 0.9375D);
        FCClientUtilsRender.RenderInvBlockWithMetadata(var1, this, -0.5F, -0.5F, -0.5F, 0);
        this.m_bRenderingInterior = true;
        var1.setRenderBounds(0.0625D, 0.0D, 0.0625D, 0.9375D, 1.0D, 0.9375D);
        ...
        var1.renderFaceYPos(this, 0.0D, -0.751D, 0.0D, this.getIcon(0, 0));
        var4.draw();
        var4.startDrawingQuads();
        var4.setNormal(0.0F, 0.0F, -1.0F);
        var1.renderFaceZNeg(this, 0.0D, 0.0D, 0.751D, this.getIcon(3, 0));
        var4.draw();
        var4.startDrawingQuads();
        var4.setNormal(0.0F, 0.0F, 1.0F);
        var1.renderFaceZPos(this, 0.0D, 0.0D, -0.751D, this.getIcon(2, 0));
        var4.draw();
        var4.startDrawingQuads();
        var4.setNormal(-1.0F, 0.0F, 0.0F);
        var1.renderFaceXNeg(this, 0.751D, 0.0D, 0.0D, this.getIcon(5, 0));
        var4.draw();
        var4.startDrawingQuads();
        var4.setNormal(1.0F, 0.0F, 0.0F);
        var1.renderFaceXPos(this, -0.751D, 0.0D, 0.0D, this.getIcon(4, 0));
        var4.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
    }
}
