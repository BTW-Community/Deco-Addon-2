...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    private void DrawSecondaryOutputIndicator()
    {
        if (!this.mc.playerController.isInCreativeMode())
        {
            FCContainerPlayer var1 = (FCContainerPlayer)this.mc.thePlayer.inventoryContainer;

            if (var1 != null)
            {
                IRecipe var2 = CraftingManager.getInstance().FindMatchingRecipe(var1.craftMatrix, this.mc.theWorld);

                if (var2 != null && var2.HasSecondaryOutput())
                {
                    Slot var3 = (Slot)var1.inventorySlots.get(0);
                    int var4 = var3.xDisplayPosition + 20;
                    int var5 = var3.yDisplayPosition + 5;
                    FCClientUtilsRender.DrawSecondaryCraftingOutputIndicator(this.mc, var4, var5);
                }
            }
        }
    }
