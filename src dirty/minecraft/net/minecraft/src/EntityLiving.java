...
public abstract class EntityLiving extends Entity
{
    ...
    protected void EntityLivingSetAttackTarget(EntityLiving var1)
    {
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTime == 20)
        {
            ...
            {
                var2 = this.getExperiencePoints(this.attackingPlayer);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    this.m_iRecentlyOnChoppingBlockCountdown = 40;
                }
    ...
    protected void EntityLivingDropFewItems(boolean var1, int var2)
    {
    ...
    protected void EntityLivingFall(float var1)
    {
        super.fall(var1);
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        if (this.isInWater() && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).capabilities.isFlying))
        {
            ...
            this.motionY -= 0.02D;
            var5 = this.GetSwimmingHorizontalModifier();
        ...
        else
        {
            ...
            if (this.onGround)
            {
                var5 = this.GetDefaultSlipperinessOnGround();
                int var6 = this.worldObj.getBlockId(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY - 0.25D), MathHelper.floor_double(this.posZ));

                if (var6 > 0)
                {
                    var5 = this.GetSlipperinessRelativeToBlock(var6);
                }
            }
            ...
            {
                var5 = this.GetDefaultSlipperinessOnGround();
                int var8 = this.worldObj.getBlockId(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY - 0.25D), MathHelper.floor_double(this.posZ));

                if (var8 > 0)
                {
                    var5 = this.GetSlipperinessRelativeToBlock(var8);
                }
            }
            ...
            if (this.isOnLadder())
            {
                ...
                float var10 = this.GetLadderVerticalMovementModifier();
        ...
        var7 = MathHelper.sqrt_double(var3 * var3 + var12 * var12) * 4.0F;
    ...
    protected void EntityLivingOnLivingUpdate()
    {
        ...
        if (this.isJumping)
        {
            if ((this.isInWater() || this.handleLavaMovement()) && this.CanSwim())
            {
    ...
    public boolean isOnLadder()
    {
        ...
        return var4 != null && var4.IsBlockClimbable(this.worldObj, var1, var2, var3);
    }

    protected void ModSpecificOnLivingUpdate()
    {
        if (this.m_iRecentlyOnChoppingBlockCountdown > 0)
        {
            --this.m_iRecentlyOnChoppingBlockCountdown;
        }
    }
    ...
    public float getSpeedModifier()
    {
        ...
        if (this.onGround && this.IsAffectedByMovementModifiers())
        {
            ...
            int var3 = MathHelper.floor_double(this.posY - 0.03D - (double)this.yOffset);
            int var4 = MathHelper.floor_double(this.posZ);

            if (FCUtilsWorld.IsGroundCoverOnBlock(this.worldObj, var2, var3, var4))
            {
                var1 *= 0.8F;
            }

            Block var5 = Block.blocksList[this.worldObj.getBlockId(var2, var3, var4)];

            if (var5 == null || var5.getCollisionBoundingBoxFromPool(this.worldObj, var2, var3, var4) == null)
            {
                float var6 = this.width / 2.0F;
                int var7 = var2;
                var2 = MathHelper.floor_double(this.posX + (double)var6);
                var5 = Block.blocksList[this.worldObj.getBlockId(var2, var3, var4)];
                ...
                if (var5 == null || var5.getCollisionBoundingBoxFromPool(this.worldObj, var2, var3, var4) == null)
                {
                    ...
                    {
                        var2 = var7;
                        var4 = MathHelper.floor_double(this.posZ + (double)var6);
                        var5 = Block.blocksList[this.worldObj.getBlockId(var7, var3, var4)];

                        if (var5 == null || var5.getCollisionBoundingBoxFromPool(this.worldObj, var7, var3, var4) == null)
                        {
                            var4 = MathHelper.floor_double(this.posZ - (double)var6);
                            var5 = Block.blocksList[this.worldObj.getBlockId(var7, var3, var4)];
                        }
            ...
            if (var5 != null)
            {
                var1 *= var5.GetMovementModifier(this.worldObj, var2, var3, var4);
            }

            var1 *= this.GetLandMovementModifier();
        }
    ...
    public void EntityLivingOnDeath(DamageSource var1)
    {
        EntityLiving var2 = this.func_94060_bK();
        ...
        {
            int var4 = this.GetAmbientLootingModifier();

            if (var3 instanceof EntityPlayer)
            {
                int var5 = EnchantmentHelper.getLootingModifier((EntityLiving)var3);
            ...
            this.dropFewItems(true, var4);
            this.dropEquipment(true, var4);
            this.CheckForRareDrop(var1, var4);
            this.CheckForHeadDrop(var1, var4);
    ...
    protected void CheckForRareDrop(DamageSource var1, int var2)
    {
        int var3 = this.rand.nextInt(800) - var2 * 4;

        if (var3 < 5)
        {
            this.dropRareDrop(var3 <= 0 ? 1 : 0);
        }
    }
    ...
    protected void CheckForHeadDrop(DamageSource var1, int var2)
    {
        ...
        else if (var1 == FCDamageSourceCustom.m_DamageSourceChoppingBlock || this.m_iRecentlyOnChoppingBlockCountdown > 0)
        {
            var4 >>= 2;
        }
    ...
    protected int GetAmbientLootingModifier()
    {
        ...
        int var3 = MathHelper.floor_double(this.posZ);
        return this.worldObj.GetAmbientLootingEffectAtLocation(var1, var2, var3);
    }
    ...
    {
        int var1 = this.GetWornArmorWeight();
        return var1 >= 10 ? true : this.IsWeightedByHeadCrab();
    }
    ...
    private boolean HasOnlyAmbientPotionEffects(Collection var1)
    {
        if (var1 != null && !var1.isEmpty())
        {
    ...
    {
        return this.worldObj.rayTraceBlocks_do_do(this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), this.worldObj.getWorldVec3Pool().getVecFromPool(par1Entity.posX, par1Entity.posY + (double)par1Entity.getEyeHeight(), par1Entity.posZ), false, true) == null;
    }

    public boolean CanEntityCenterOfMassBeSeen(Entity var1)
    {
        return this.worldObj.rayTraceBlocks_do_do(this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), this.worldObj.getWorldVec3Pool().getVecFromPool(var1.posX, var1.posY + (double)(var1.height / 2.0F), var1.posZ), false, true) == null;
    }
    ...
    {
        return Block.blocksList[var1].slipperiness * 0.91F;
    }
    ...
    protected void despawnEntity()
    {
        ...
        {
            int var1 = MathHelper.floor_double(this.posX / 16.0D);
            int var2 = MathHelper.floor_double(this.posZ / 16.0D);

            if (!this.worldObj.IsChunkActive(var1, var2))
            {
                this.setDead();
            }
            else
            {
                EntityPlayer var3 = this.worldObj.getClosestPlayerToEntity(this, this.MinDistFromPlayerForDespawn());
    ...
    protected boolean IsInsideSpawnAreaAroundPlayer(EntityPlayer var1)
    {
        return this.IsInsideSpawnAreaAroundChunk(MathHelper.floor_double(var1.posX / 16.0D), MathHelper.floor_double(var1.posZ / 16.0D));
    }

    protected boolean IsInsideSpawnAreaAroundOriginalSpawn()
    {
        return this.worldObj.provider.dimensionId == 0 && this.IsInsideSpawnAreaAroundChunk(this.worldObj.worldInfo.getSpawnX() >> 4, this.worldObj.worldInfo.getSpawnZ() >> 4);
    }

    protected boolean IsInsideSpawnAreaAroundChunk(int var1, int var2)
    {
        int var3 = this.worldObj.GetMobSpawnRangeInChunks();
        int var4 = MathHelper.floor_double(this.posX / 16.0D);
        int var5 = var1 - var4;

        if (var5 >= -var3 && var5 <= var3)
        {
            int var6 = MathHelper.floor_double(this.posZ / 16.0D);
            int var7 = var2 - var6;

            if (var7 >= -var3 && var7 <= var3)
            {
                return true;
            }
        }
    ...
    public boolean MeleeAttack(Entity var1)
    {
        this.setLastAttackingEntity(var1);
        int var2 = this.GetMeleeAttackStrength(var1);
        ...
        if (var4)
        {
            ...
            else if (this.isBurning() && this.rand.nextFloat() < 0.6F)
            {
                var1.setFire(4);
            }
    ...
    public MovingObjectPosition MouseOverCustomRayTrace(double var1, float var3)
    {
        ...
        return this.worldObj.MouseOverRayTrace(var4, var6);
    }
}
