    ...
    protected boolean teleportTo(double par1, double par3, double par5)
    {
        ...
        if (this.worldObj.blockExists(var14, var15, var16))
        {
            ...
            if (var18)
            {
                ...
                {
                    Block var19 = Block.blocksList[this.worldObj.getBlockId(var14, var15 - 1, var16)];

                    if (var19 != null && var19.CanMobsSpawnOn(this.worldObj, var14, var15 - 1, var16))
                    {
                        var13 = true;
                    }
                }
        ...
        else
        {
            ...
            {
                double var31 = (double)var17 / ((double)var30 - 1.0D);
                ...
                double var24 = var7 + (this.posX - var7) * var31 + (this.rand.nextDouble() - 0.5D) * (double)this.width * 2.0D;
                double var26 = var9 + (this.posY - var9) * var31 + this.rand.nextDouble() * (double)this.height;
                double var28 = var11 + (this.posZ - var11) * var31 + (this.rand.nextDouble() - 0.5D) * (double)this.width * 2.0D;
