...
public class FCEntityVillager extends EntityVillager
{
    ...
    public void useRecipe(MerchantRecipe var1)
    {
        ...
        else if (var1.getItemToBuy().itemID == FCBetterThanWolves.fcAestheticNonOpaque.blockID && var1.getItemToBuy().getItemDamage() == 12)
        {
    ...
    public double GetHeadCrabRangeForSquid()
    {
        return 1.0D;
    }
    ...
    private void CheckForPeasantTrades(MerchantRecipeList var1)
    {
        ...
        this.CheckForWishToSellMultipleItemsTrade(var1, Item.wheat.itemID, 0.2F, 8, 16, 2);
    ...
    private MerchantRecipe GetPeasantLevelUpRecipe()
    {
        ...
        switch (var1)
        {
            ...
            case 4:
                return new MerchantRecipe(new ItemStack(FCBetterThanWolves.fcPlanter, this.rand.nextInt(5) + 8, 2), new ItemStack(Item.emerald.itemID, 4, 0), -var1);
    ...
    private void CheckForButcherTrades(MerchantRecipeList var1)
    {
        ...
        this.CheckForComplexTrade(var1, new ItemStack(FCBetterThanWolves.fcAestheticNonOpaque, 1, 12), new ItemStack(FCBetterThanWolves.fcItemSoap, 1), new ItemStack(Item.emerald, this.rand.nextInt(3) + 3), 0.1F, 5);
