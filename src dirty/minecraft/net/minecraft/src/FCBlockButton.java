...
{
    private static final double m_dItemDepth = 0.375D;
    private static final double m_dItemHalfDepth = 0.1875D;
    private static final double m_dItemWidth = 0.25D;
    private static final double m_dItemHalfWidth = 0.125D;
    private static final double m_dItemHeight = 0.25D;
    private static final double m_dItemHalfHeight = 0.125D;
    ...
    {
        return AxisAlignedBB.getAABBPool().getAABB(0.3125D, 0.375D, 0.375D, 0.6875D, 0.625D, 0.625D);
    }
