...
public class AxisAlignedBB extends FCUtilsPrimitiveGeometric
{
    ...
    public void RotateAroundJToFacing(int var1)
    {
        if (var1 > 2)
        {
            if (var1 == 5)
            {
                this.setBounds(1.0D - this.maxZ, this.minY, 1.0D - this.maxX, 1.0D - this.minZ, this.maxY, 1.0D - this.minX);
            }
            else if (var1 == 4)
            {
            ...
            {
                this.setBounds(1.0D - this.maxX, this.minY, 1.0D - this.maxZ, 1.0D - this.minX, this.maxY, 1.0D - this.minZ);
            }
        }
    }
    ...
    public void TiltToFacingAlongJ(int var1)
    {
        if (var1 == 0)
        {
            this.setBounds(1.0D - this.maxX, 1.0D - this.maxY, this.minZ, 1.0D - this.minX, 1.0D - this.minY, this.maxZ);
        }
        else if (var1 == 2)
        {
            this.setBounds(this.minX, this.minZ, 1.0D - this.maxY, this.maxX, this.maxZ, 1.0D - this.minY);
        }
        else if (var1 == 3)
        {
            this.setBounds(this.minX, 1.0D - this.maxZ, this.minY, this.maxX, 1.0D - this.minZ, this.maxY);
        }
        else if (var1 == 4)
        {
            this.setBounds(1.0D - this.maxY, this.minX, this.minZ, 1.0D - this.minY, this.maxX, this.maxZ);
        }
        else if (var1 == 5)
        {
            this.setBounds(this.minY, 1.0D - this.maxX, this.minZ, this.maxY, 1.0D - this.minX, this.maxZ);
        }
    }

    public void Translate(double var1, double var3, double var5)
    {
        this.offset(var1, var3, var5);
    }

    public void AddToRayTrace(FCUtilsRayTraceVsComplexBlock var1)
    {
        var1.AddBoxWithLocalCoordsToIntersectionList(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
    }
    ...
    {
        AxisAlignedBB var7 = this.MakeTemporaryCopy().offset((double)var2, (double)var3, (double)var4);
        var7.AddToListIfIntersects(var5, var6);
    }

    public void ExpandToInclude(AxisAlignedBB var1)
    {
    ...
    public void AddToListIfIntersects(AxisAlignedBB var1, List var2)
    {
        if (this.intersectsWith(var1))
        {
            var2.add(this);
        }
    }
    ...
    public boolean RenderAsBlock(RenderBlocks var1, Block var2, int var3, int var4, int var5)
    {
        ...
        return var1.renderStandardBlock(var2, var3, var4, var5);
    }
    ...
    {
        var1.setRenderBounds(this);
        return var1.renderStandardBlockWithColorMultiplier(var2, var3, var4, var5, var6, var7, var8);
    }

    public boolean RenderAsBlockWithTexture(RenderBlocks var1, Block var2, int var3, int var4, int var5, Icon var6)
    {
        var1.setRenderBounds(this);
        FCClientUtilsRender.RenderStandardBlockWithTexture(var1, var2, var3, var4, var5, var6);
        return true;
    }
    ...
    {
        var1.setRenderBounds(this);
        FCClientUtilsRender.RenderBlockFullBrightWithTexture(var1, var1.blockAccess, var3, var4, var5, var6);
        return true;
    }
