...
public class EntityTrackerEntry
{
    ...
    public void sendLocationToAllClients(List par1List)
    {
        ...
        if (this.myEntity instanceof EntityItemFrame && this.ticks % 10 == 0)
        {
            ...
            if (var24 != null && var24.getItem() instanceof ItemMap)
            {
                ...
                Iterator var29 = this.trackingPlayers.iterator();
    ...
    {
        return par1EntityPlayerMP.getServerForPlayer().GetChunkTracker().IsChunkWatchedByPlayerAndSentToClient(par1EntityPlayerMP, this.myEntity.chunkCoordX, this.myEntity.chunkCoordZ);
    }
    ...
    private Packet getPacketForThisEntity()
    {
        ...
        if (this.myEntity instanceof FCIEntityPacketHandler)
        {
            FCIEntityPacketHandler var9 = (FCIEntityPacketHandler)this.myEntity;
        ...
        else if (!(this.myEntity instanceof IAnimals) && !(this.myEntity instanceof EntityDragon))
        {
            ...
            else
            {
                ...
                if (this.myEntity instanceof EntityFireball)
                {
                    ...
                    {
                        var1 = new Packet23VehicleSpawn(this.myEntity, var3, ((EntityFireball)this.myEntity).shootingEntity.entityId);
                    }
                    else
                    {
                        var1 = new Packet23VehicleSpawn(this.myEntity, var3, 0);
                    }

                    var1.speedX = (int)(var6.accelerationX * 8000.0D);
                    var1.speedY = (int)(var6.accelerationY * 8000.0D);
                    var1.speedZ = (int)(var6.accelerationZ * 8000.0D);
                    return var1;
                }
                ...
                {
                    EntityItemFrame var2 = (EntityItemFrame)this.myEntity;
                    var1 = new Packet23VehicleSpawn(this.myEntity, 71, var2.hangingDirection);
                    var1.xPosition = MathHelper.floor_float((float)(var2.xPosition * 32));
                    var1.yPosition = MathHelper.floor_float((float)(var2.yPosition * 32));
                    var1.zPosition = MathHelper.floor_float((float)(var2.zPosition * 32));
                    return var1;
                }
