...
public class EntityRenderer
{
    ...
    private float m_fPreviousSunBrightness = -1.0F;
    ...
    private void updateLightmap(float par1)
    {
        ...
        if (var2 != null)
        {
            for (int var3 = 0; var3 < 256; ++var3)
            {
                ...
                {
                    var14 = this.fPreviousWithEffectIntensity + (this.fWitherEffectIntensity - this.fPreviousWithEffectIntensity) * par1;
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            if (this.mc.gameSettings.fancyGraphics)
            {
                ...
                int var16 = var5.sortAndRender(var4, 1, (double)par1);
    ...
    private void addRainParticles()
    {
        ...
        if (var1 != 0.0F)
        {
            ...
            for (int var16 = 0; var16 < var15; ++var16)
            {
                ...
                if (var19 <= var5 + var7 && var19 >= var5 - var7 && var21.CanRainInBiome() && var21.getFloatTemperature() >= 0.2F)
                {
    ...
    protected void renderRainSnow(float par1)
    {
        ...
        var2 *= 0.5F;
        var2 += this.mc.theWorld.thunderingStrength * 0.5F;
    ...
    private void updateFogColor(float par1)
    {
        ...
        if (this.cloudFog)
        {
            Vec3 var14 = var2.getCloudColour(par1);
            this.fogColorRed = (float)var14.xCoord;
            this.fogColorGreen = (float)var14.yCoord;
            this.fogColorBlue = (float)var14.zCoord;
        }
        ...
        double var15 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)par1) * var2.provider.getVoidFogYFactor();
        ...
        if (var15 < 1.0D)
        {
            ...
            var15 *= var15;
            this.fogColorRed = (float)((double)this.fogColorRed * var15);
            this.fogColorGreen = (float)((double)this.fogColorGreen * var15);
            this.fogColorBlue = (float)((double)this.fogColorBlue * var15);
        }
        ...
        if (var3.isPotionActive(Potion.nightVision))
        {
            ...
            var18 = 1.0F / this.fogColorRed;

            if (var18 > 1.0F / this.fogColorGreen)
            {
                var18 = 1.0F / this.fogColorGreen;
            }

            if (var18 > 1.0F / this.fogColorBlue)
            {
                var18 = 1.0F / this.fogColorBlue;
            }

            this.fogColorRed = this.fogColorRed * (1.0F - var23) + this.fogColorRed * var18 * var23;
        }

        if (this.mc.gameSettings.anaglyph)
        {
            var23 = (this.fogColorRed * 30.0F + this.fogColorGreen * 59.0F + this.fogColorBlue * 11.0F) / 100.0F;
            var18 = (this.fogColorRed * 30.0F + this.fogColorGreen * 70.0F) / 100.0F;
    ...
    private void ModUpdateLightmap(float var1)
    {
        WorldClient var2 = this.mc.theWorld;
        ...
        if (var2 != null)
        {
            ...
            {
                this.ModUpdateLightmapOverworld(var2, var1);
                return;
            }

            this.m_fPreviousSunBrightness = -1.0F;
            this.updateLightmap(var1);
        }
    }

    private void ModUpdateLightmapOverworld(WorldClient var1, float var2)
    {
        float var3 = var1.ComputeOverworldSunBrightnessWithMoonPhases();

        if (this.m_fPreviousSunBrightness > -0.01F && Math.abs(var3 - this.m_fPreviousSunBrightness) > 0.001F)
        {
            if (var3 > this.m_fPreviousSunBrightness)
            {
                var3 = this.m_fPreviousSunBrightness + 0.001F;
            }
            else
            {
                var3 = this.m_fPreviousSunBrightness - 0.001F;
        ...
        this.m_fPreviousSunBrightness = var3;
        float var4 = var3;
        boolean var5 = this.mc.thePlayer.isPotionActive(Potion.nightVision);

        for (int var6 = 0; var6 < 256; ++var6)
        {
            float var10 = var1.provider.lightBrightnessTable[var6 % 16] * (this.torchFlickerX * 0.1F + 1.5F);
            float var11 = var10 * ((var10 * 0.6F + 0.4F) * 0.6F + 0.4F);
            float var12 = var10 * (var10 * var10 * 0.6F + 0.4F);
            float var13 = var1.provider.lightBrightnessTable[var6 / 16] * var4;

            if (var1.lastLightningBolt > 0)
            {
                var13 = var1.provider.lightBrightnessTable[var6 / 16];
            }

            float var14 = var13 * (var3 * 0.65F + 0.35F);
            float var7 = var14 + var10;
            float var8 = var14 + var11;
            float var9 = var13 + var12;
            float var16;

            if (this.fWitherEffectIntensity > 0.0F)
            {
                var16 = this.fPreviousWithEffectIntensity + (this.fWitherEffectIntensity - this.fPreviousWithEffectIntensity) * var2;
                var7 = var7 * (1.0F - var16) + var7 * 0.7F * var16;
                var8 = var8 * (1.0F - var16) + var8 * 0.6F * var16;
                var9 = var9 * (1.0F - var16) + var9 * 0.6F * var16;
            }
            ...
            if (var5)
            {
                var7 = var7 * 0.96F + 0.03F;
                var17 = this.getNightVisionBrightness(this.mc.thePlayer, var2);
                var18 = 1.0F / var7;
                ...
                var7 = var7 * (1.0F - var17) + var7 * var18 * var17;
            }

            var17 = 1.0F - var16;
            var7 = var7 * var17 + var16;
            var8 = var8 * var17 + var16;
            var9 = var9 * var17 + var16;
            ...
            var18 = this.mc.gameSettings.gammaSetting;
            float var19 = 1.0F - var7;
            float var20 = 1.0F - var8;
            float var21 = 1.0F - var9;
            var19 = 1.0F - var19 * var19 * var19 * var19;
            var20 = 1.0F - var20 * var20 * var20 * var20;
            var21 = 1.0F - var21 * var21 * var21 * var21;
            var7 = var7 * (1.0F - var18) + var19 * var18;
            var8 = var8 * (1.0F - var18) + var20 * var18;
            var9 = var9 * (1.0F - var18) + var21 * var18;
            var7 = var7 * var17 + var16;
            var8 = var8 * var17 + var16;
            var9 = var9 * var17 + var16;
            ...
            short var22 = 255;
            int var23 = (int)(var7 * 255.0F);
            int var24 = (int)(var8 * 255.0F);
            int var25 = (int)(var9 * 255.0F);
            this.lightmapColors[var6] = var22 << 24 | var23 << 16 | var24 << 8 | var25;
        }
