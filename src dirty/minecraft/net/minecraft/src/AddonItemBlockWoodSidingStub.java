...
public class AddonItemBlockWoodSidingStub extends ItemBlock {
    public AddonItemBlockWoodSidingStub(int var1)
    {
        super(var1);
    ...
    {
        return AddonBlockPlanks.GetFurnaceBurnTimeByWoodType(var1) / 2;
    }
}
