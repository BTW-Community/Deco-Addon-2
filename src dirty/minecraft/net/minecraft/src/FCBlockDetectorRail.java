...
public class FCBlockDetectorRail extends BlockDetectorRail
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        {
            this.blockIcon = var1.registerIcon("detectorRail");
            this.m_IconOn = var1.registerIcon("detectorRail_on");
        }
        else
        {
            this.blockIcon = var1.registerIcon(this.getUnlocalizedName2());
            this.m_IconOn = var1.registerIcon(this.getUnlocalizedName2() + "_on");
        }
    }
    ...
    {
        return this.IsOnFromMetadata(var2) ? this.m_IconOn : this.blockIcon;
    }
}
