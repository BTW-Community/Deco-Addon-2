...
public class AddonItemBlockWoodMouldingStub extends ItemBlock
{
    public AddonItemBlockWoodMouldingStub(int var1)
    {
        super(var1);
    ...
    public int GetBlockIDToPlace(int var1, int var2, float var3, float var4, float var5)
    {
        switch (var1)
        {
            ...
            case 5:
            	return AddonDefs.cherryMouldingAndDecorative.blockID;
            default:
                return FCBetterThanWolves.fcBlockWoodOakMouldingAndDecorative.blockID;
        }
    }
    ...
    {
        return AddonBlockPlanks.GetFurnaceBurnTimeByWoodType(var1) / 4;
    }
}
