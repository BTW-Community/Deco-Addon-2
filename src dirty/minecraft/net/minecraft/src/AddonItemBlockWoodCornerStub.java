...
public class AddonItemBlockWoodCornerStub extends ItemBlock
{
    public AddonItemBlockWoodCornerStub(int var1)
    {
        super(var1);
    ...
    {
        return AddonBlockPlanks.GetFurnaceBurnTimeByWoodType(var1) / 8;
    }
}
