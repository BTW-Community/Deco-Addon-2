...
public class FCBlockMycelium extends BlockMycelium
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_iconTop = var1.registerIcon("mycel_top");
        this.m_iconSnowSide = var1.registerIcon("snow_side");
    }
    ...
    {
        return var5 == 1 ? this.m_iconTop : (var5 == 0 ? Block.dirt.getBlockTextureFromSide(var5) : (this.m_bTempHasSnowOnTop ? this.m_iconSnowSide : this.blockIcon));
    }
