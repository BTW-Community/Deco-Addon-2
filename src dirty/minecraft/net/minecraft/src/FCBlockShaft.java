...
public class FCBlockShaft extends Block
{
    ...
    {
        FCUtilsBlockPos var6 = new FCUtilsBlockPos(var2, var3, var4, Block.GetOppositeFacing(var5));
        int var7 = this.GetFacing(var1, var6.i, var6.j, var6.k);
        return var5 == var7 ? !FCClientUtilsRender.ShouldRenderNeighborFullFaceSide(var1, var2, var3, var4, var5) : true;
    }
    ...
    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        ...
        if (this.IsSupportingOtherBlock(var1.blockAccess, var2, var3, var4))
        {
            var5 = m_boxShaftSupporting.MakeTemporaryCopy();
        }
        else
        ...
        var5.TiltToFacingAlongJ(this.GetFacing(var1.blockAccess, var2, var3, var4));
        return var5.RenderAsBlock(var1, this, var2, var3, var4);
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World var1, int var2, int var3, int var4)
    {
        ...
        if (this.IsSupportingOtherBlock(var1, var2, var3, var4))
        {
            var5 = m_boxSelectionSupporting.MakeTemporaryCopy();
        }
        else
        {
            var5 = m_boxSelection.MakeTemporaryCopy();
        }
