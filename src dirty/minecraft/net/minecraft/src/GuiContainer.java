...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (int var9 = 0; var9 < this.inventorySlots.inventorySlots.size(); ++var9)
        {
            Slot var10 = (Slot)this.inventorySlots.inventorySlots.get(var9);
            this.drawSlotInventory(var10);

            if (this.isMouseOverSlot(var10, par1, par2))
            {
                this.theSlot = var10;
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
                int var11 = var10.xDisplayPosition;
                var8 = var10.yDisplayPosition;
                this.drawGradientRect(var11, var8, var11 + 16, var8 + 16, -2130706433, -2130706433);
        ...
        {
            byte var17 = 8;
            var8 = this.draggedStack == null ? 8 : 16;
            String var12 = null;
            ...
            this.drawItemStack(var16, par1 - var4 - var17, par2 - var5 - var8, var12);
        }
        ...
        if (this.returningStack != null)
        {
            ...
            var8 = this.returningStackDestSlot.xDisplayPosition - this.field_85049_r;
            int var20 = this.returningStackDestSlot.yDisplayPosition - this.field_85048_s;
            int var13 = this.field_85049_r + (int)((float)var8 * var18);
            int var14 = this.field_85048_s + (int)((float)var20 * var18);
    ...
    protected void func_102021_a(List par1List, int par2, int par3)
    {
        if (!par1List.isEmpty())
        {
            ...
            while (var5.hasNext())
            {
                ...
                var7 = this.fontRenderer.getStringWidth(var6);
            ...
            for (int var12 = 0; var12 < par1List.size(); ++var12)
            {
                ...
                this.fontRenderer.drawStringWithShadow(var13, var14, var7, -1);
    ...
    private void func_94066_g()
    {
        ...
        if (var1 != null && this.field_94076_q)
        {
            ...
            for (Iterator var4 = this.field_94077_p.iterator(); var4.hasNext(); this.field_94069_F -= var2.stackSize - var3)
            {
                Slot var5 = (Slot)var4.next();
                var2 = var1.copy();
                var3 = var5.getStack() == null ? 0 : var5.getStack().stackSize;
                Container.func_94525_a(this.field_94077_p, this.field_94071_C, var2, var3);
                ...
                if (var2.stackSize > var5.getSlotStackLimit())
                {
                    var2.stackSize = var5.getSlotStackLimit();
                }
            }
        }
    }
            ...
            if (isShiftKeyDown())
            {
                if (var4 != null && var4.inventory != null && this.field_94075_K != null)
                {
                    ...
                    while (var10.hasNext())
                    {
                        ...
                        if (var9 != null && var9.canTakeStack(this.mc.thePlayer) && var9.getHasStack() && var9.inventory == var4.inventory && Container.func_94527_a(var9, this.field_94075_K, true))
                        {
                            this.handleMouseClick(var9, var9.slotNumber, par3, 1);
                        }
                    }
                }
            }
        ...
        else
        {
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen)
            {
                if (par3 == 0 || par3 == 1)
                {
                    ...
                    var11 = Container.func_94527_a(var4, this.draggedStack, false);
            ...
            else if (this.field_94076_q && !this.field_94077_p.isEmpty())
            {
                ...
                var10 = this.field_94077_p.iterator();

                while (var10.hasNext())
                {
                    var9 = (Slot)var10.next();
                    this.handleMouseClick(var9, var9.slotNumber, Container.func_94534_d(1, this.field_94071_C), 5);
                }
    ...
    private boolean DrawSlotSpecialItems(Slot var1, ItemStack var2)
    {
        if (var2 != null)
        {
            int var3 = var2.getItem().itemID;

            if (!this.IsPlayerInventorySlot(var1))
            {
                if (var3 == Item.pocketSundial.itemID)
                {
                    TextureClock.m_clockTexture.UpdateInert();
                    itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.renderEngine, var2, var1.xDisplayPosition, var1.yDisplayPosition);
                    TextureClock.m_clockTexture.updateAnimation();
                    return true;
                }
            }
            else if (var3 == Item.compass.itemID)
            {
    ...
    private boolean IsPlayerInventorySlot(Slot var1)
    {
        return this.mc.thePlayer.inventory == var1.inventory;
    }
