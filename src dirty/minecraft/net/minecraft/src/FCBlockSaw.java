...
public class FCBlockSaw extends Block implements FCIBlockMechanical
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_IconFront = var1.registerIcon("fcBlockSaw_front");
        this.m_IconBladeOff = var1.registerIcon("fcBlockSawBlade_off");
        this.m_IconBladeOn = var1.registerIcon("fcBlockSawBlade_on");
    }
    ...
    {
        return var1 == 1 ? this.m_IconFront : this.blockIcon;
    }
    ...
    {
        int var6 = this.GetFacing(var1, var2, var3, var4);
        return var5 == var6 ? this.m_IconFront : this.blockIcon;
    }
    ...
    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        ...
        Icon var10 = this.m_IconBladeOff;

        if (this.IsBlockOn(var5, var2, var3, var4))
        {
            var10 = this.m_IconBladeOn;
        }
    ...
    public void RenderBlockAsItem(RenderBlocks var1, int var2, float var3)
    {
        ...
        FCClientUtilsRender.RenderInvBlockWithTexture(var1, this, -0.5F, -0.5F, -0.5F, this.m_IconBladeOff);
    }
}
