        ...
        else
        {
            ...
            switch (this.roomType)
            {
                ...
                case 2:
                    ...
                    int var6 = FCBetterThanWolves.fcBlockLadder.SetFacing(0, var5);
                    this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var6, 9, 1, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var6, 9, 2, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, FCBetterThanWolves.fcBlockLadder.blockID, var6, 9, 3, 3, par3StructureBoundingBox);
