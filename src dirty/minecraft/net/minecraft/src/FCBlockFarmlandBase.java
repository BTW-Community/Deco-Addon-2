...
public abstract class FCBlockFarmlandBase extends Block
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_iconTopWet = var1.registerIcon("farmland_wet");
        this.m_iconTopDry = var1.registerIcon("farmland_dry");
    }
    ...
    {
        return var1 == 1 ? (this.IsHydrated(var2) ? this.m_iconTopWet : this.m_iconTopDry) : this.blockIcon;
    }
