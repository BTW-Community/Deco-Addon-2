...
public class EffectRenderer
{
    ...
    {
        float var3 = MathHelper.cos(par1Entity.rotationYaw * 0.017453292F);
        float var4 = MathHelper.sin(par1Entity.rotationYaw * 0.017453292F);
        float var5 = -var4 * MathHelper.sin(par1Entity.rotationPitch * 0.017453292F);
        float var6 = var3 * MathHelper.sin(par1Entity.rotationPitch * 0.017453292F);
        float var7 = MathHelper.cos(par1Entity.rotationPitch * 0.017453292F);
        byte var8 = 3;
