...
public class FCBlockKiln extends Block
{
    ...
    {
        this.blockIcon = var1.registerIcon("brick");
        this.m_cookIcons = new Icon[7];

        for (int var2 = 0; var2 < 7; ++var2)
        {
            this.m_cookIcons[var2] = var1.registerIcon("fcOverlayCook_" + (var2 + 1));
        }
    }
    ...
    public Icon GetCookTextureForCurrentState(IBlockAccess var1, int var2, int var3, int var4)
    {
        int var5 = this.GetCookCounter(var1, var2, var3, var4) / 2 - 1;
        return var5 >= 0 && var5 <= 6 ? this.m_cookIcons[var5] : null;
    }
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        if (var6 != null && var6.GetCanBeCookedByKiln(var1, var2, var3 + 1, var4) && this.CheckKilnIntegrity(var1, var2, var3, var4))
        {
            int var7;
            double var8;
            double var10;
            ...
            if (!var6.renderAsNormalBlock())
            {
                for (var7 = 0; var7 < 2; ++var7)
                {
                    var8 = (double)var2 + var5.nextDouble();
                    var10 = (double)var3 + 1.0D + var5.nextDouble() * 0.75D;
                    var12 = (double)var4 + var5.nextDouble();
                    var1.spawnParticle("fcwhitesmoke", var8, var10, var12, 0.0D, 0.0D, 0.0D);
                }
            }
            else
            {
                for (var7 = 2; var7 < 6; ++var7)
                {
                    var8 = (double)var2 + 0.5D;
                    var10 = (double)var3 + 1.0D + var5.nextDouble() * 0.75D;
