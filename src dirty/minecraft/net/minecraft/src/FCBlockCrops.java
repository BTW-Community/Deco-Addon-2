...
public abstract class FCBlockCrops extends FCBlockPlants
{
    ...
    protected void RenderCrops(RenderBlocks var1, int var2, int var3, int var4)
    {
        Tessellator var5 = Tessellator.instance;
        var5.setBrightness(this.getMixedBrightnessForBlock(var1.blockAccess, var2, var3, var4));
        var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
        double var6 = 0.0D;
        Block var8 = Block.blocksList[var1.blockAccess.getBlockId(var2, var3 - 1, var4)];

        if (var8 != null)
        {
            var6 = (double)var8.GroundCoverRestingOnVisualOffset(var1.blockAccess, var2, var3 - 1, var4);
        }

        this.RenderCrossHatch(var1, var2, var3, var4, this.getBlockTexture(var1.blockAccess, var2, var3, var4, 0), 0.25D, var6);
    }
