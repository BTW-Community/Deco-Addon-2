...
public class InventoryMerchant implements IInventory
{
    ...
    {
        ItemStack var1 = this.theInventory[2];

        if (var1 != null && var1.itemID == FCBetterThanWolves.fcItemAncientProphecy.itemID)
        {
            ItemStack var2 = this.theInventory[0];

            if (var2.itemID != Item.enchantedBook.itemID)
            {
                var2 = this.theInventory[1];
            }

            short var3 = -1;
            NBTTagList var4 = Item.enchantedBook.func_92110_g(var2);

            if (var4 != null && var4.tagCount() > 0)
            {
                short var5 = ((NBTTagCompound)var4.tagAt(0)).getShort("id");
            ...
            ((FCItemAncientProphecy)FCBetterThanWolves.fcItemAncientProphecy).InitializeProphecyDataFromEnchantmentID(var1, var3);
        }
    }
}
