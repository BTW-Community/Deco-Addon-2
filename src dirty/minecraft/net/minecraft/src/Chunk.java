...
public class Chunk
{
    ...
    public void GetClosestEntityMatchingCriteriaWithinRangeSq(FCClosestEntityInfo var1)
    {
        for (int var2 = var1.m_iChunkEntityListMinVerticalIndex; var2 <= var1.m_iChunkEntityListMaxVerticalIndex; ++var2)
        {
            List var3 = this.entityLists[var2];
            ...
            if (!var3.isEmpty())
            {
                ...
                while (var4.hasNext())
                {
                    ...
                    var1.m_criteria.ProcessEntity(var1, var5);
                }
            }
        }
    }

    public int GetBlockNaturalLightValue(int var1, int var2, int var3, int var4)
    {
