...
public class FCEntityWolf extends EntityWolf
{
    ...
    {
        return this.isTamed() ? (this.IsStarving() ? "/btwmodtex/fcWolf_tame_starving.png" : "/mob/wolf_tame.png") : (this.isAngry() ? "/mob/wolf_angry.png" : (this.IsStarving() ? "/btwmodtex/fcWolf_wild_starving.png" : this.texture));
    }
