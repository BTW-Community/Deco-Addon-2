...
public class FCBlockBloodWoodLeaves extends FCBlockLeaves
{
    ...
    {
        this.blockIcon = var1.registerIcon("leaves");
        this.m_IconLowDetail = var1.registerIcon("leaves_opaque");
    }
    ...
    {
        return !Block.leaves.graphicsLevel ? this.m_IconLowDetail : this.blockIcon;
    }
