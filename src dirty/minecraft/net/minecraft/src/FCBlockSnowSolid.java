...
public class FCBlockSnowSolid extends Block
{
    ...
    public FCBlockSnowSolid(int var1)
    {
        ...
        this.setUnlocalizedName("fcBlockSnowSolid");
    ...
    {
        int var5 = FCBetterThanWolves.fcBlockSnowLoose.SetHardeningLevel(0, 7);
        var1.setBlockAndMetadataWithNotify(var2, var3, var4, FCBetterThanWolves.fcBlockSnowLoose.blockID, var5);
        FCBetterThanWolves.fcBlockSnowLoose.ScheduleCheckForFall(var1, var2, var3, var4);
    }
