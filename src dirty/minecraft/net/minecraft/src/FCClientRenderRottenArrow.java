...
public class FCClientRenderRottenArrow extends Render
{
    ...
    {
        this.RenderArrow((FCEntityRottenArrow)var1, var2, var4, var6, var8, var9);
    }

    public void RenderArrow(FCEntityRottenArrow var1, double var2, double var4, double var6, float var8, float var9)
    {
        if (var1.prevRotationYaw != 0.0F || var1.prevRotationPitch != 0.0F)
        {
            this.loadTexture("/btwmodtex/fcrotten.png");
            GL11.glPushMatrix();
