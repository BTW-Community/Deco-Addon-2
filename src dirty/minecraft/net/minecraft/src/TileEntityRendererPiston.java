...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer
{
    ...
    public void renderPiston(TileEntityPiston par1TileEntityPiston, double par2, double par4, double par6, float par8)
    {
        ...
        if (var9 != null && par1TileEntityPiston.getProgress(par8) < 1.0F)
        {
            ...
            else if (par1TileEntityPiston.getBlockMetadata() == par1TileEntityPiston.worldObj.getBlockMetadata(par1TileEntityPiston.xCoord, par1TileEntityPiston.yCoord, par1TileEntityPiston.zCoord))
            {
                var9.m_currentBlockRenderer = this.blockRenderer;
                var9.RenderBlockMovedByPiston(this.blockRenderer, par1TileEntityPiston.xCoord, par1TileEntityPiston.yCoord, par1TileEntityPiston.zCoord);
            }
