...
public class FCClientModelPig extends ModelPig
{
    ...
    public FCClientModelPig(float var1)
    {
        super(var1);
    }
    ...
    public void setLivingAnimations(EntityLiving var1, float var2, float var3, float var4)
    {
        ...
        FCEntityPig var5 = (FCEntityPig)var1;

        if (!var5.isChild())
        {
            this.head.rotationPointY = 12.0F + var5.GetGrazeHeadVerticalOffset(var4) * 4.0F;
        }
        else
        {
            this.head.rotationPointY = 12.0F + var5.GetGrazeHeadVerticalOffset(var4) * 2.0F;
        }
