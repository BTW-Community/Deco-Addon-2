...
public class FCBlockNetherrackFalling extends FCBlockFalling
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_iconEmbers = var1.registerIcon("fcOverlayNetherrackEmbers");
    }
    ...
    public void RenderFallingBlock(RenderBlocks var1, int var2, int var3, int var4, int var5)
    {
        ...
        if (var5 != 0)
        {
            ...
            var6.setBrightness(var1.blockAccess.getLightBrightnessForSkyBlocks(var2, var3, var4, 15));
            var1.renderFaceYPos((Block)null, (double)var2, (double)var3, (double)var4, this.m_iconEmbers);
        }
