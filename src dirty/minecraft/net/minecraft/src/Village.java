...
public class Village
{
    ...
    private void removeDeadAndOutOfRangeDoors()
    {
        ...
        while (var3.hasNext())
        {
            ...
            if (this.worldObj.chunkExists(var4.posX >> 4, var4.posZ >> 4) && (!this.isBlockDoor(var4.posX, var4.posY, var4.posZ) || Math.abs(this.tickCounter - var4.lastActivityTimestamp) > 1200))
            {
