...
public abstract class Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if (!this.worldObj.isRemote && this.worldObj instanceof WorldServer)
        {
            ...
            MinecraftServer var2 = ((WorldServer)this.worldObj).getMinecraftServer();
            ...
            if (this.inPortal)
            {
                ...
                {
                    if (this.ridingEntity == null && this.field_82153_h++ >= var1)
                    {
        ...
        if (this.isSprinting() && !this.isInWater())
        {
            ...
            var1 = MathHelper.floor_double(this.posY - 0.20000000298023224D - (double)this.yOffset);
            int var6 = MathHelper.floor_double(this.posZ);
            int var4 = this.worldObj.getBlockId(var5, var1, var6);

            if (var4 > 0)
            {
                this.worldObj.spawnParticle("tilecrack_" + var4 + "_" + this.worldObj.getBlockMetadata(var5, var1, var6), this.posX + ((double)this.rand.nextFloat() - 0.5D) * (double)this.width, this.boundingBox.minY + 0.1D, this.posZ + ((double)this.rand.nextFloat() - 0.5D) * (double)this.width, -this.motionX * 4.0D, 1.5D, -this.motionZ * 4.0D);
            }
        }
    ...
    protected void playStepSound(int par1, int par2, int par3, int par4)
    {
        ...
        int var6 = this.worldObj.getBlockId(par1, par2 + 1, par3);
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        try
        {
            ...
            par1NBTTagCompound.setTag("fcMin", this.newDoubleNBTList(new double[] {this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ}));
            par1NBTTagCompound.setTag("fcMax", this.newDoubleNBTList(new double[] {this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ}));
    ...
    public void unmountEntity(Entity par1Entity)
    {
        ...
        if (par1Entity != null)
        {
            ...
            var4 = par1Entity.boundingBox.minY + (double)par1Entity.height;
            var6 = par1Entity.posZ;
        }
        ...
        for (double var8 = -1.5D; var8 < 2.0D; ++var8)
        {
            for (double var10 = -1.5D; var10 < 2.0D; ++var10)
            {
                if (var8 != 0.0D || var10 != 0.0D)
                {
                    ...
                    if (this.worldObj.getCollidingBlockBounds(var14).isEmpty())
                    {
    ...
    {
        return this.riddenByEntity != null && this.riddenByEntity instanceof FCEntitySquid;
    }
    ...
    {
        this.FlingAwayFromEntity(var1, this.GetCowKickMovementMultiplier());
    }
    ...
    public void FlingAwayFromEntity(Entity var1, double var2)
    {
        if (this.ridingEntity != null)
        {
        ...
        double var4 = this.motionX;
        double var6 = this.motionZ;
        double var8 = this.posX - var1.posX;
        double var10 = this.posZ - var1.posZ;
        ...
        if (var12 > 0.1D)
        {
            ...
            var4 += var8 / var14 * 0.5D * var2;
            var6 += var10 / var14 * 0.5D * var2;
        }

        this.isAirBorne = true;
        var14 = this.motionY + 0.25D * var2;
        var4 *= this.rand.nextDouble() * 0.2D + 0.9D;
        var6 *= this.rand.nextDouble() * 0.2D + 0.9D;
        this.motionX = FCUtilsMath.ClampDouble(var4, -1.0D, 1.0D);
        this.motionY = FCUtilsMath.ClampDoubleTop(var14, 0.75D);
        this.motionZ = FCUtilsMath.ClampDouble(var6, -1.0D, 1.0D);
    }
    ...
    public boolean IsBeingRainedOn()
    {
        ...
        int var2 = MathHelper.floor_double(this.boundingBox.maxY);
        int var3 = MathHelper.floor_double(this.posZ);
        return this.worldObj.IsRainingAtPos(var1, var2, var3);
    }
    ...
    public void moveEntity(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            boolean var14 = this.onGround && this.isSneaking() && this instanceof EntityPlayer;
            double var15;
            ...
            if (var14)
            {
                ...
                while (par1 != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.getOffsetBoundingBox(par1, -1.0D, 0.0D)).isEmpty())
                {
                ...
                while (par5 != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.getOffsetBoundingBox(0.0D, -1.0D, par5)).isEmpty())
                {
            ...
            double var17 = par3;
            double var19 = par5;
            AxisAlignedBB var21 = this.boundingBox.addCoord(par1, par3, par5);

            if ((double)this.stepHeight > par3)
            {
                var21.maxY = this.boundingBox.maxY + (double)this.stepHeight;
            }

            List var22 = this.worldObj.getCollidingBoundingBoxes(this, var21);

            for (int var23 = 0; var23 < var22.size(); ++var23)
            {
                par3 = ((AxisAlignedBB)var22.get(var23)).calculateYOffset(this.boundingBox, par3);
            }

            this.boundingBox.offset(0.0D, par3, 0.0D);
            boolean var37 = this.onGround || var17 != par3 && var17 < 0.0D;
            int var24;

            for (var24 = 0; var24 < var22.size(); ++var24)
            {
                par1 = ((AxisAlignedBB)var22.get(var24)).calculateXOffset(this.boundingBox, par1);
            }
            ...
            for (var24 = 0; var24 < var22.size(); ++var24)
            {
                par5 = ((AxisAlignedBB)var22.get(var24)).calculateZOffset(this.boundingBox, par5);
            }
            ...
            if (this.stepHeight > 0.0F && var37 && (var14 || this.ySize < 0.05F) && (var15 != par1 || var19 != par5))
            {
                var38 = par1;
                var26 = par3;
                var28 = par5;
                ...
                par5 = var19;
                AxisAlignedBB var30 = this.boundingBox.copy();
                this.boundingBox.setBB(var13);

                for (var31 = 0; var31 < var22.size(); ++var31)
                {
                    par3 = ((AxisAlignedBB)var22.get(var31)).calculateYOffset(this.boundingBox, par3);
                }
                ...
                for (var31 = 0; var31 < var22.size(); ++var31)
                {
                    par1 = ((AxisAlignedBB)var22.get(var31)).calculateXOffset(this.boundingBox, par1);
                }
                ...
                for (var31 = 0; var31 < var22.size(); ++var31)
                {
                    par5 = ((AxisAlignedBB)var22.get(var31)).calculateZOffset(this.boundingBox, par5);
                }
                ...
                if (var38 * var38 + var28 * var28 >= par1 * par1 + par5 * par5)
                {
                    par1 = var38;
                    par3 = var26;
                    par5 = var28;
                    this.boundingBox.setBB(var30);
                }
            }
            ...
            this.posY = this.boundingBox.minY + (double)this.yOffset - (double)this.ySize;
            this.posZ = (this.boundingBox.minZ + this.boundingBox.maxZ) / 2.0D;
            this.isCollidedHorizontally = var15 != par1 || var19 != par5;
            this.isCollidedVertically = var17 != par3;
            this.onGround = var17 != par3 && var17 < 0.0D;
            ...
            var26 = this.posY - var9;
            var28 = this.posZ - var11;

            if (this.canTriggerWalking() && !var14 && this.ridingEntity == null)
            {
                int var39 = MathHelper.floor_double(this.posX);
                var31 = MathHelper.floor_double(this.posY - 0.03D - (double)this.yOffset);
                int var32 = MathHelper.floor_double(this.posZ);
                int var33 = this.worldObj.getBlockId(var39, var31, var32);
                int var34 = var31;

                if (var33 == 0)
                {
                    int var35 = this.worldObj.blockGetRenderType(var39, var31 - 1, var32);

                    if (var35 == 11 || var35 == 32 || var35 == 21)
                    {
                        var33 = this.worldObj.getBlockId(var39, var31 - 1, var32);
                        var34 = var31 - 1;
                    }
                }

                Block var41 = Block.blocksList[var33];

                if (var41 == null || !var41.IsBlockClimbable(this.worldObj, var39, var34, var32))
                {
                    var26 = 0.0D;
                }

                this.distanceWalkedModified += MathHelper.sqrt_double(var38 * var38 + var28 * var28) * 0.6F;
                this.distanceWalkedOnStepModified += MathHelper.sqrt_double(var38 * var38 + var26 * var26 + var28 * var28) * 0.6F;

                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var33 > 0)
                {
                    this.nextStepDistance = (int)this.distanceWalkedOnStepModified + 1;

                    if (this.isInWater())
                    {
                        float var36 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224D + this.motionY * this.motionY + this.motionZ * this.motionZ * 0.20000000298023224D) * 0.35F;
                        ...
                        this.playSound("liquid.swim", var36, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
                    }

                    this.playStepSound(var39, var31, var32, var33);
                    Block.blocksList[var33].onEntityWalking(this.worldObj, var39, var31, var32, this);
                }
            }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            boolean var2 = false;
            NBTTagList var19 = par1NBTTagCompound.getTagList("Pos");
            this.prevPosX = this.lastTickPosX = this.posX = ((NBTTagDouble)var19.tagAt(0)).data;
            this.prevPosY = this.lastTickPosY = this.posY = ((NBTTagDouble)var19.tagAt(1)).data;
            this.prevPosZ = this.lastTickPosZ = this.posZ = ((NBTTagDouble)var19.tagAt(2)).data;
            NBTTagList var20;

            if (par1NBTTagCompound.hasKey("fcMin"))
            {
                var2 = true;
                var20 = par1NBTTagCompound.getTagList("fcMin");
                double var5 = ((NBTTagDouble)var20.tagAt(0)).data;
                double var7 = ((NBTTagDouble)var20.tagAt(1)).data;
                double var9 = ((NBTTagDouble)var20.tagAt(2)).data;
                NBTTagList var11 = par1NBTTagCompound.getTagList("fcMax");
                double var12 = ((NBTTagDouble)var11.tagAt(0)).data;
                double var14 = ((NBTTagDouble)var11.tagAt(1)).data;
                double var16 = ((NBTTagDouble)var11.tagAt(2)).data;
                this.boundingBox.setBounds(var5, var7, var9, var12, var14, var16);
            }
            else
            {
                this.setPosition(this.posX, this.posY, this.posZ);
            ...
            var20 = par1NBTTagCompound.getTagList("Motion");
            this.motionX = ((NBTTagDouble)var20.tagAt(0)).data;
            this.motionY = ((NBTTagDouble)var20.tagAt(1)).data;
            this.motionZ = ((NBTTagDouble)var20.tagAt(2)).data;
            ...
            NBTTagList var21 = par1NBTTagCompound.getTagList("Rotation");
            this.prevRotationYaw = this.rotationYaw = ((NBTTagFloat)var21.tagAt(0)).data;
            this.prevRotationPitch = this.rotationPitch = ((NBTTagFloat)var21.tagAt(1)).data;
            ...
            if (!var2 && this.ShouldSetPositionOnLoad())
            {
                this.setPosition(this.posX, this.posY, this.posZ);
            }
        }
