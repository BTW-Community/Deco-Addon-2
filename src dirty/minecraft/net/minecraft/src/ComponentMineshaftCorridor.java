    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            for (var5 = 0; var5 < this.sectionCount; ++var5)
            {
                ...
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.1F, 0, 2, var6 - 1, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.1F, 2, 2, var6 - 1, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.1F, 0, 2, var6 + 1, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.1F, 2, 2, var6 + 1, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 0, 2, var6 - 2, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 2, 2, var6 - 2, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 0, 2, var6 + 2, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 2, 2, var6 + 2, FCBetterThanWolves.fcBlockWeb.blockID, 0);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var6 - 1, FCBetterThanWolves.fcBlockTorchFiniteUnlit.blockID, 8);
                this.randomlyPlaceBlock(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var6 + 1, FCBetterThanWolves.fcBlockTorchFiniteUnlit.blockID, 8);
