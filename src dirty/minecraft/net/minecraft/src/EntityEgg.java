...
public class EntityEgg extends EntityThrowable
{
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        if (!this.worldObj.isRemote && this.rand.nextInt(8) == 0)
        {
            ...
            {
                FCEntityChicken var4 = new FCEntityChicken(this.worldObj);
        ...
        {
            FCUtilsItem.EjectSingleItemWithRandomVelocity(this.worldObj, (float)this.posX, (float)this.posY, (float)this.posZ, FCBetterThanWolves.fcItemRawEgg.itemID, 0);
        }
