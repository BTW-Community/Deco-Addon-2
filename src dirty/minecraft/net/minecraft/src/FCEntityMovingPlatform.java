...
public class FCEntityMovingPlatform extends Entity implements FCIEntityPacketHandler, FCIEntityIgnoreServerValidation
{
    ...
    private void ClientPushPlayer(Entity var1)
    {
        ...
        double var4 = this.boundingBox.maxY + 0.01D - var2;
        var1.setPosition(var1.posX, var1.posY + var4, var1.posZ);
        ...
        if (var1.riddenByEntity != null)
        {
            var1.riddenByEntity.setPosition(var1.riddenByEntity.posX, var1.riddenByEntity.posY + var4, var1.riddenByEntity.posZ);
        }
