...
public class TileEntityFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        int var2 = this.furnaceCookTime * par1 / this.GetCookTimeForCurrentItem();

        if (var2 == 0 && this.isBurning() && this.canSmelt())
        {
            var2 = 1;
        }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            boolean var6 = this.furnaceItemStacks[0] != null || this.furnaceItemStacks[2] != null;
            FCBlockFurnace var4 = (FCBlockFurnace)Block.blocksList[this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord)];

            if (var1 != this.furnaceBurnTime > 0)
            {
                var2 = true;
                var4.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord, var6);
            }
            else
            {
                boolean var5 = (this.worldObj.getBlockMetadata(this.xCoord, this.yCoord, this.zCoord) & 8) != 0;
    ...
    protected boolean canSmelt()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                return var2 <= this.getInventoryStackLimit() && var2 <= this.furnaceItemStacks[2].getMaxStackSize() ? true : var2 <= var1.getMaxStackSize();
            }
        }
    }
    ...
    protected int GetCookTimeForCurrentItem()
    {
        ...
        if (this.furnaceItemStacks[0] != null)
        {
            var1 = FurnaceRecipes.smelting().GetCookTimeBinaryShift(this.furnaceItemStacks[0].getItem().itemID);
        }
    ...
    {
        return par0ItemStack != null ? par0ItemStack.getItem().GetFurnaceBurnTime(par0ItemStack.getItemDamage()) * 2 : 0;
    }
}
