...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart
{
        ...
        else
        {
            ...
            if (this.worldObj.isRemote)
            {
                if (this.newPosRotationIncrements > 0)
                {
                    ...
                    var28 = this.posY + (this.newPosY - this.posY) / (double)this.newPosRotationIncrements;
            ...
            else
            {
                ...
                var28 /= (double)MathHelper.sqrt_double(var10 * var10 + var6 * var6);
                var12 = 0.6F;
                ...
                this.motionY += var28 * 0.10000000149011612D;
                this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
                ...
                Vec3 var31 = this.worldObj.getWorldVec3Pool().getVecFromPool(this.targetX - this.posX, this.targetY - this.posY, this.targetZ - this.posZ).normalize();
                ...
                var34 = (float)(var18.dotProduct(var31) + 0.5D) / 1.5F;
                ...
                var24 = 0.06F;
                this.moveFlying(0.0F, -1.0F, var24 * (var34 * var23 + (1.0F - var23)));
                ...
                var26 = (float)(var25.dotProduct(var18) + 1.0D) / 2.0F;
            ...
            float var14 = this.rotationYaw * (float)Math.PI / 180.0F;
            float var30 = MathHelper.sin(var14);
            float var16 = MathHelper.cos(var14);
            this.dragonPartBody.onUpdate();
            this.dragonPartBody.setLocationAndAngles(this.posX + (double)(var30 * 0.5F), this.posY, this.posZ - (double)(var16 * 0.5F), 0.0F, 0.0F);
            this.dragonPartWing1.onUpdate();
            this.dragonPartWing1.setLocationAndAngles(this.posX + (double)(var16 * 4.5F), this.posY + 2.0D, this.posZ + (double)(var30 * 4.5F), 0.0F, 0.0F);
            this.dragonPartWing2.onUpdate();
            this.dragonPartWing2.setLocationAndAngles(this.posX - (double)(var16 * 4.5F), this.posY + 2.0D, this.posZ - (double)(var30 * 4.5F), 0.0F, 0.0F);
            ...
            double[] var33 = this.getMovementOffsets(0, 1.0F);
            var12 = MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
            var34 = MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
            this.dragonPartHead.onUpdate();
            this.dragonPartHead.setLocationAndAngles(this.posX + (double)(var12 * 5.5F * var3), this.posY + (var33[1] - var32[1]) * 1.0D + (double)(var29 * 5.5F), this.posZ - (double)(var34 * 5.5F * var3), 0.0F, 0.0F);
            ...
            for (int var35 = 0; var35 < 3; ++var35)
            {
                ...
                double[] var22 = this.getMovementOffsets(12 + var35 * 2, 1.0F);
                var23 = this.rotationYaw * (float)Math.PI / 180.0F + this.simplifyAngle(var22[0] - var32[0]) * (float)Math.PI / 180.0F * 1.0F;
                var24 = MathHelper.sin(var23);
                float var37 = MathHelper.cos(var23);
                var26 = 1.5F;
                float var27 = (float)(var35 + 1) * 2.0F;
                var36.onUpdate();
                var36.setLocationAndAngles(this.posX - (double)((var30 * var26 + var24 * var27) * var3), this.posY + (var22[1] - var32[1]) * 1.0D - (double)((var27 + var26) * var29) + 1.5D, this.posZ + (double)((var16 * var26 + var37 * var27) * var3), 0.0F, 0.0F);
            }
    ...
    private void setNewTarget()
    {
        ...
        if (this.rand.nextInt(2) == 0 && !this.worldObj.playerEntities.isEmpty())
        {
            ...
            long var2 = ((EntityPlayer)this.target).m_lTimeOfLastDimensionSwitch;
            long var4 = this.worldObj.getWorldTime();

            if (var4 < var2 || var4 - var2 > 600L)
            {
                var1 = true;
            }
        }
