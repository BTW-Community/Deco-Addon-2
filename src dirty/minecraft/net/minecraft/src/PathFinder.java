...
public class PathFinder
{
    ...
    {
        return this.GetPathWeightAtLocation(par1Entity, par2, par3, par4, par5PathPoint);
    }
            ...
            for (int var10 = par2; var10 < par2 + par4PathPoint.yCoord; ++var10)
            {
                for (int var11 = par3; var11 < par3 + par4PathPoint.zCoord; ++var11)
                {
                    ...
                    if (var12 > 0)
                    {
                        ...
                        {
                            int var15 = MathHelper.floor_double(par0Entity.posX);
                        ...
                        else if (!var13.getBlocksMovement(par0Entity.worldObj, var9, var10, var11) && (!par6 || var12 != Block.doorWood.blockID))
                        {
                            ...
                            Material var18 = var13.blockMaterial;
    ...
    public int GetPathWeightAtLocation(Entity var1, int var2, int var3, int var4, PathPoint var5)
    {
        boolean var6 = this.isPathingInWater;
        boolean var7 = this.isMovementBlockAllowed;
        boolean var8 = this.isWoddenDoorAllowed;
        World var9 = var1.worldObj;
        int var10 = 1;
        int var11 = var2 + var5.xCoord;
        int var12 = var3 + var5.yCoord;
        int var13 = var4 + var5.zCoord;

        for (int var14 = var2; var14 < var11; ++var14)
        {
            for (int var15 = var3; var15 < var12; ++var15)
            {
                for (int var16 = var4; var16 < var13; ++var16)
                {
                    int var17 = var9.getBlockId(var14, var15, var16);

                    if (var17 > 0)
                    {
                        Block var18 = Block.blocksList[var17];

                        if (!var18.CanPathThroughBlock(var9, var14, var15, var16, var1, this))
                        {
                            return var18.GetWeightOnPathBlocked(var9, var14, var15, var16);
                        }

                        var10 = var18.AdjustPathWeightOnNotBlocked(var10);
                    }
                }
            }
        }
    ...
    private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        int var10 = MathHelper.floor_double(par1Entity.boundingBox.minX);
        int var11 = MathHelper.floor_double(par1Entity.boundingBox.minY + 0.5D);
        int var12 = MathHelper.floor_double(par1Entity.boundingBox.minZ);

        if (this.canEntityDrown && par1Entity.isInWater())
        {
            var11 = (int)par1Entity.boundingBox.minY;

            for (int var19 = this.worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var11, MathHelper.floor_double(par1Entity.posZ)); var19 == Block.waterMoving.blockID || var19 == Block.waterStill.blockID; var19 = this.worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var11, MathHelper.floor_double(par1Entity.posZ)))
            {
                ++var11;
            }
        ...
        else if (this.ShouldOffsetPositionIfPathingOutOfBlock(var10, var11, var12, par1Entity))
        {
            double var13 = par1Entity.posX - (double)var10;
            int var15 = var10 + (var13 < 0.5D ? -1 : 1);

            if (!this.CanPathThroughBlock(var15, var11, var12, par1Entity))
            {
                double var16 = par1Entity.posZ - (double)var12;
                int var18 = var12 + (var16 < 0.5D ? -1 : 1);

                if (!this.CanPathThroughBlock(var10, var11, var18, par1Entity))
                {
                    if (this.CanPathThroughBlock(var15, var11, var18, par1Entity))
                    {
                        var10 = var15;
                        var12 = var18;
                    }
        ...
        PathPoint var20 = this.openPoint(var10, var11, var12);
        PathPoint var14 = this.openPoint(MathHelper.floor_double(par2 - (double)(par1Entity.width / 2.0F)), MathHelper.floor_double(par4), MathHelper.floor_double(par6 - (double)(par1Entity.width / 2.0F)));
        PathPoint var21 = new PathPoint(MathHelper.floor_float(par1Entity.width + 1.0F), MathHelper.floor_float(par1Entity.height + 1.0F), MathHelper.floor_float(par1Entity.width + 1.0F));
        PathEntity var22 = this.addToPath(par1Entity, var20, var14, var21, par8);
        this.isPathingInWater = var9;
        return var22;
    }

    private boolean ShouldOffsetPositionIfPathingOutOfBlock(int var1, int var2, int var3, Entity var4)
    {
        int var5 = this.worldMap.getBlockId(var1, var2, var3);

        if (var5 > 0)
        {
            Block var6 = Block.blocksList[var5];
            return var6.ShouldOffsetPositionIfPathingOutOf(this.worldMap, var1, var2, var3, var4, this);
        }
        else
        {
            return false;
    ...
    private boolean CanPathThroughBlock(int var1, int var2, int var3, Entity var4)
    {
        int var5 = this.worldMap.getBlockId(var1, var2, var3);
        ...
        {
            Block var6 = Block.blocksList[var5];
            return var6.CanPathThroughBlock(this.worldMap, var1, var2, var3, var4, this);
        }
        else
        {
            return true;
