...
public class FCBlockCompanionCube extends Block
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_IconFront = var1.registerIcon("fcBlockCompanionCube_front");
        this.m_IconGuts = var1.registerIcon("fcBlockCompanionCube_guts");
    }
    ...
    public Icon getBlockTexture(IBlockAccess var1, int var2, int var3, int var4, int var5)
    {
        ...
        else if (var5 == this.GetFacing(var1, var2, var3, var4))
        {
            return this.m_IconFront;
        }
    ...
    {
        return var1 > 0 ? AxisAlignedBB.getAABBPool().getAABB(0.0D, 0.0D, 0.0D, 1.0D, 0.5D, 1.0D) : super.GetBlockBoundsFromPoolForItemRender(var1);
    }
