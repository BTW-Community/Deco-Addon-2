                            ...
                            for (var10 = 0; var10 < 2; ++var10)
                            {
                                for (var11 = 0; var11 < 4; ++var11)
                                {
                                    if (par2Random.nextInt(4 - var10) == 0)
                                    {
                                        ...
                                        this.setBlockAndMetadata(par1World, par3 + Direction.offsetX[Direction.rotateOpposite[var11]], par4 + var6 - 5 + var10, par5 + Direction.offsetZ[Direction.rotateOpposite[var11]], Block.cocoaPlant.blockID, var13 << 2 | var11);
                                    }
                                }
                            }
                        }
