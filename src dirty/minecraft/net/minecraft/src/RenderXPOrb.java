...
public class RenderXPOrb extends Render
{
    ...
    public void renderTheXPOrb(EntityXPOrb par1EntityXPOrb, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        float var22 = 255.0F;
        float var23 = ((float)par1EntityXPOrb.xpColor + par9) / 2.0F;
        var21 = (int)((MathHelper.sin(var23 + 0.0F) + 1.0F) * 0.5F * var22);
        int var24 = (int)var22;
        int var25 = (int)((MathHelper.sin(var23 + 4.1887903F) + 1.0F) * 0.1F * var22);

        if (par1EntityXPOrb.m_bNotPlayerOwned)
        {
            var21 = (int)((MathHelper.sin(var23 / 10.0F) + 1.0F) * 0.5F * var22);
            var25 = 0;
            var24 = 0;
            var21 = (var21 >> 2) + 64;
        }

        int var26 = var21 << 16 | var24 << 8 | var25;
